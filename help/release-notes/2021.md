...
| Tema escuro | O [tema escuro](/help/analyze/analysis-workspace/user-preferences.md#dark-theme) está disponível como uma opção de exibição. | 21 de outubro de 2021 |
...
| ----------- | ---------- | ---------- |
| Fim de vida útil do Reports &amp; Analytics | 4 de janeiro de 2022 | A partir de **31 de dezembro de 2023**, a Adobe pretende descontinuar o Reports &amp; Analytics, juntamente com os relatórios e recursos que o acompanham. Os relatórios, as visualizações e as tecnologias subjacentes que alimentam o Reports &amp; Analytics não atendem mais aos padrões de tecnologia da Adobe. A maioria dos recursos do Reports &amp; Analytics está disponível no [Analysis Workspace](/help/analyze/analysis-workspace/home.md). Desde o lançamento do Analysis Workspace em 2015, a funcionalidade e os recursos do Reports &amp; Analytics foram movidos para o Analysis Workspace e um limite de paridade de fluxo de trabalho foi atingido. [Este aviso](https://spark.adobe.com/page/6WnF8JK6IRDhf) explica o processo do fim da vida útil. |
...
| Recurso | Descrição | [Disponibilidade geral](/help/release-notes/releases.md) - Data do Target |
| ----------- | ---------- | ------- |
...
| Fazer logon para atualizar para o [!UICONTROL Report Builder] | 9 de abril de 2021 | Em 14 de janeiro de 2021, as atualizações de logon do [!UICONTROL Report Builder] removeram as dependências das tecnologias herdadas e alinharam o processo de logon com o CX Enterprise. O CX Enterprise usa sua Enterprise ID (email e senha). Para garantir acesso ininterrupto ao [!UICONTROL Report Builder], atualize o suplemento [!UICONTROL Report Builder] para a versão 5.6.47 ou posterior **até 22 de julho de 2021**. O Report Builder versão 5.6.47 e posterior é compatível apenas com o logon corporativo do CX e não será compatível com o logon único. |

{style="table-layout:auto"}

### AppMeasurement

Para obter as atualizações mais recentes sobre as versões do AppMeasurement (versão 2.22.1), consulte as [notas de versão do AppMeasurement para JavaScript](/help/implement/appmeasurement-updates.md).
...
Para obter as atualizações mais recentes das versões do AppMeasurement, consulte as [notas de versão do AppMeasurement para JavaScript](/help/implement/appmeasurement-updates.md).
...
* Atualização da documentação sobre [distinção entre maiúsculas e minúsculas de eVars em relatórios](/help/components/dimensions/evar.md). (AN-246438)
* Atualização da documentação para explicar melhor a [Implementação do feed de dados](/help/export/analytics-data-feed/create-feed.md) e [aqui](/help/export/analytics-data-feed/df-faq.md#BucketOwnerFullControl). (AN-219485)
...
| Recurso | [Disponibilidade geral](releases.md) - Data do Target | Descrição |
| ----------- | ---------- | ------- |
| Workspace: versões anteriores do projeto | 20 de maio de 2021 | Permite carregar versões anteriores de um projeto do Workspace para desfazer alterações indesejadas ou simplesmente reverter para uma versão anterior preferencial. [Saiba mais](/help/analyze/analysis-workspace/build-workspace-project/save-projects.md#previous-version) |
