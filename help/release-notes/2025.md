...
| **Navegação atualizada na interface de Atributos do cliente** | A interface do usuário de Atributos do cliente agora pode ser acessada diretamente do seletor de aplicativos na Adobe CX Enterprise. Selecione **[!UICONTROL Atributos do cliente]** no menu suspenso (em vez de acessar a seção [!UICONTROL Pessoas] > [!UICONTROL Atributos do cliente]) e atualize seus marcadores.  A atualização inclui algumas melhorias na interface. | 1 de julho de 2025 | 31 de julho de 2025 |
...
| **Navegação atualizada na interface de Atributos do cliente** | A interface do usuário de Atributos do cliente agora pode ser acessada diretamente do seletor de aplicativos na Adobe CX Enterprise. |  | A ser determinado |
