...
| **Dimensões exclusivas do Data Warehouse** | Com base no feedback de clientes, decidimos reavaliar nossa decisão. Não lançaremos o recurso de dimensões automático exclusivo para data warehouse conforme anunciado anteriormente. | | A ser definido |
