...
| Recomendação de desempenho da visualização de fluxo | Adição de informações que explicam que deixar mais de 10 nós expandidos em uma única visualização de fluxo pode afetar o tempo da geração de relatórios. |
| Revisão e atualizações | Revisão e atualização da documentação do Analysis Workspace. Quando apropriado, a documentação agora está sincronizada com a documentação do Customer Journey Analytics no Analysis Workspace. |
| **Junho de 2025** | |
...
| Alteração do período de retenção da ID de transação | O período de retenção da ID de transação de 90 dias foi estendido para 25 meses. A variável transactionID identifica exclusivamente uma transação para que o hit possa ser vinculado a dados enviados por meio de fontes de dados. Consulte [variáveis de página](/help/implement/vars/page-vars/transactionid.md) e [fontes de dados](/help/import/data-sources/transactionid.md). |
...
| Nova documentação sobre Agendamento no novo Report Builder | O [Agendamento](/help/analyze/report-builder/schedule-reportbuilder.md) não só permite que você agende suas novas pastas de trabalho do Report Builder, mas também permite que você recupere os metadados em tarefas agendadas antigas ao converter pastas de trabalho legadas. |
| Melhorias nos relatórios (também conhecidos como modelos) no Analysis Workspace | Várias melhorias estão disponíveis para os Relatórios (também conhecidos como [Modelos](/help/analyze/analysis-workspace/templates/use-templates.md)) |
...
| Novo Report Builder | [Nova documentação](/help/analyze/report-builder/rb-overview.md) para o complemento do Report Builder simplificado e compatível com Mac, Windows e navegadores da web. |
| **Agosto de 2024** | |
| Gerenciador de alertas | Documentação simplificada sobre o [Gerenciador de alertas](/help/components/alerts/alert-manager.md). Atualizada para aumentar a clareza e a precisão. |
| **Julho de 2024** | |
| Eventos bem-sucedidos | Documentação simplificada sobre [eventos bem-sucedidos](/help/admin/tools/manage-rs/edit-settings/conversion-var-admin/c-success-events/success-event.md). Atualizada para aumentar a clareza e a precisão. |
...
| **Janeiro de 2024** | |
| A migração de componentes se aplica a organizações do IMS individuais | Esclarecido que a [migração de componentes](/help/admin/tools/component-migration/component-migration.md) não é compatível com a migração entre organizações do IMS. |
| Esclarecido que determinadas informações estão disponíveis somente para administradores | Foram adicionadas informações declarando que as colunas &quot;Usado pela última vez&quot; e &quot;Usado em&quot; descritas em [Gerenciador de métricas calculadas](/help/components/calculated-metrics/workflow/cm-manager.md) e [Gerenciador de segmentos](/help/components/segmentation/segmentation-workflow/seg-manage.md) estão disponíveis somente para administradores do sistema. |
...
| Melhorias na documentação de relatórios da Coleção de mídia de streaming | Parte do conteúdo foi reorganizada na seção Relatórios do guia da Coleção de mídia de streaming, incluindo a consolidação da documentação da API em sua própria seção e o ajuste da ordem de alguns artigos. |
| **Agosto de 2023** | |
...
| Relatórios de bots no Workspace | Os relatórios de bots agora estão disponíveis no Analysis Workspace. Este recurso vem com várias adições:<ul><li>Uma nova dimensão: [Nome do bot](/help/components/dimensions/bot-name.md)</li><li>Duas novas métricas: [Visualizações de página por bots](/help/components/metrics/bot-page-views.md) e [Ocorrências de bots](/help/components/metrics/bot-occurrences.md).</li><li>Um novo modelo de métrica calculada: [Taxa de visualizações de página por bots](/help/components/calculated-metrics/cm-reference/default-calcmetrics.md)</li><li>Um novo relatório do Workspace: Relatórios de bots</li></ul>As novas métricas e dimensão contêm dados que são preenchidos retroativamente a partir de março de 2023. |
| **Maio de 2023** | |
...
| **Abril de 2023** | |
| Transferir ativos de usuários e definir expirações de conta | Foram adicionadas informações sobre como [transferir ativos de usuários e definir expirações de conta](/help/admin/tools/user-management/users-assets.md). |
...
| Visão geral das variáveis de tráfego (propriedades) | Adição de seções e procedimentos passo a passo para esclarecer e melhorar o conteúdo do artigo. Mescla do conteúdo de um artigo intitulado “Habilitar relatórios de variável de tráfego” e remoção desse artigo. Consulte [Visão geral das variáveis de tráfego (propriedades)](/help/admin/tools/manage-rs/edit-settings/c-traffic-variables/traffic-var.md). |
| Filtros internos de URL | Adição de seções e procedimentos passo a passo para esclarecer e melhorar o conteúdo do artigo. Consulte [Filtros internos de URL](/help/admin/tools/manage-rs/edit-settings/general/internal-url-filter-admin.md). |
...
| Métricas calculadas padrão | Adição de conteúdo explicando as [métricas calculadas padrão fornecidas pela Adobe](/help/components/calculated-metrics/cm-reference/default-calcmetrics.md). |
...
| Aplicativo móvel: exibições de detalhes personalizadas | Novo tópico sobre [exibições de detalhes personalizadas](/help/analyze/mobile-app/create-scorecard.md). |
...
| **Abril de 2022** | |
| Atualizações da página de destino do Adobe Analytics | Atualizações na [página de destino conjunta do Analysis Workspace/Reports &amp; Analytics](/help/analyze/landing.md) que melhoram a usabilidade e a facilidade de navegação. |
...
| Atualizações da página de destino do Adobe Analytics | [Atualizações](/help/analyze/landing.md) na página de destino conjunta do Analysis Workspace/Reports &amp; Analytics que melhoram a usabilidade e a facilidade de navegação. |
...
| **Fevereiro de 2022** | |
| Modo de visualização do projeto do cartão de pontuação para dispositivos móveis | O [modo de visualização](/help/analyze/mobile-app/create-scorecard.md#preview) permite visualizar a experiência antes de salvar e compartilhar um cartão de pontuação. |
...
| --- | --- |
| **Outubro de 2021** |  |
| 21 de outubro de 2021 | Nova documentação sobre [Segmentos rápidos](/help/analyze/analysis-workspace/components/segments/quick-segments.md) no Analysis Workspace |
...
| 5 de agosto de 2021 | Novo tópico sobre Contar instâncias repetidas. |
...
| 3 de junho de 2021 | Atualização da documentação para explicar melhor a [Implementação do feed de dados](/help/export/analytics-data-feed/create-feed.md) e o [BucketOwnerFullControl](/help/export/analytics-data-feed/df-faq.md#BucketOwnerFullControl). |
| 25 de maio de 2021 | Atualização da documentação sobre [distinção entre maiúsculas e minúsculas de eVars em relatórios](/help/components/dimensions/evar.md). |
...
| 8 de dezembro de 2020 | Atualizações para a página [Criar novo projeto](/help/analyze/analysis-workspace/build-workspace-project/freeform-overview.md) no Espaço de trabalho. |
| **Novembro de 2020** | |
| 24 de novembro de 2020 | Atualizações para a página [Visão geral do painel](/help/analyze/analysis-workspace/c-panels/panels.md) no Espaço de trabalho. |
| 24 de novembro de 2020 | Novos documentos de análise de implementação: <ul><li>[Análise completa da implementação](/help/implement/review/full-review.md)</li><li>[Análise focada da implementação](/help/implement/review/focused-review.md)</li></ul> |
| 24 de novembro de 2020 | Atualização da página [Visão geral das visualizações](/help/analyze/analysis-workspace/visualizations/freeform-analysis-visualizations.md) do Analysis Workspace. |
| 12 de novembro de 2020 | Nova página sobre [Implementação herdada do Adobe Analytics](/help/implement/prepare/existing-implementation.md). |
| 2 de novembro de 2020 | Atualização do documento sobre [FTP para classificações](/help/export/ftp-and-sftp/c-set-up-ftp-accounts/ftp-saint.md). |
| **Outubro de 2020** | |
| 23 de outubro de 2020 | Visualização de linha do Espaço de trabalho: [Opção de linha de tendência de média móvel](/help/analyze/analysis-workspace/visualizations/line.md): essa configuração foi adicionada às configurações de linha de tendência da visualização [!UICONTROL Linha]. Também conhecida como média variável, uma média móvel usa um número específico de pontos de dados (determinado por uma seleção de **[!UICONTROL Períodos]**), faz a média deles e usa a média como um ponto na linha. |
| 23 de outubro de 2020 | A página [Ajuda de desempenho](/help/analyze/analysis-workspace/workspace-faq/optimizing-performance.md) do Espaço de trabalho mostra os diferentes fatores que afetam o desempenho do projeto e links para dicas de otimização. |
...
| **Setembro de 2020** | |
| 17 de setembro de 2020 | [Baixar 50 mil itens para uma única dimensão](/help/analyze/analysis-workspace/curate-share/download-send.md#download-items): agora é possível baixar 50.000 itens para uma única dimensão em uma tabela de forma livre, com segmentos e filtros aplicados. Dessa forma, você pode acessar mais de 400 linhas de dados fora do Analysis Workspace. |
| 17 de setembro de 2020 | [Melhorias na visualização de Linha](/help/analyze/analysis-workspace/visualizations/line.md): <ul><li>Você pode exibir ou ocultar o eixo x e o eixo y de qualquer visualização de [!UICONTROL Linha]. Pode ser especialmente útil quando suas visualizações de [!UICONTROL linha] são mais compactas.</li><li>É possível sobrepor um rótulo de valor mínimo e máximo em qualquer visualização de linha para destacar rapidamente os picos e vales em uma métrica.</li><li>É possível sobrepor diferentes linhas de tendência de regressão em qualquer visualização de linha para ver mais facilmente a tendência nos dados. As opções incluem [!UICONTROL Linear], [!UICONTROL Logarítmico], [!UICONTROL Exponencial], [!UICONTROL Potência] e [!UICONTROL Quadrático].</li></ul> |
...
| 17 de setembro de 2020 | Nova documentação sobre o [painel Visualizador simultâneo de mídia no Espaço de trabalho](/help/analyze/analysis-workspace/c-panels/media-concurrent-viewers.md) |
| **Agosto de 2020** | |
| 31 de agosto de 2020 | Adição de melhorias na [documentação de compilação em campo](/help/components/cda/field-based-stitching.md) no Cross-Device Analytics. |
| **Julho de 2020** | |
...
| 18 de junho de 2020 | Nova documentação sobre [Attribution: atribuição algorítmica](/help/analyze/analysis-workspace/attribution/algorithmic.md) |
| 18 de junho de 2020 | Nova documentação sobre [Attribution: janelas de retrospectiva personalizada](/help/analyze/analysis-workspace/attribution/models.md#lookback-windows) |
| 18 de junho de 2020 | Nova documentação para [Funções de projeto](/help/analyze/analysis-workspace/curate-share/share-projects.md) para projetos compartilhados do Espaço de trabalho. Ao compartilhar um projeto do Espaço de trabalho, você pode colocar recipients em uma das três funções do projeto, dependendo da experiência do projeto que você deseja que eles tenham: Editar, Duplicar e Visualizar. |
| 18 de junho de 2020 | Nova documentação sobre [“Exibir somente” projetos do Espaço de trabalho](/help/analyze/analysis-workspace/curate-share/view-only-projects.md). Os projetos podem ser compartilhados com os usuários somente como “Pode exibir”. Quando um recipient de visualização abre o projeto compartilhado, ele recebe uma experiência de projeto mais restritiva, sem o painel esquerdo e com interações limitadas. |
...
| 12 de fevereiro de 2020 | Adição de novas teclas de atalho [esta página do Espaço de trabalho](/help/analyze/analysis-workspace/build-workspace-project/fa-shortcut-keys.md) |
...
| 12 de setembro de 2019 | Atualize o documento [Totais de métricas calculadas](/help/components/calculated-metrics/cm-totals.md). |
| 28 de agosto de 2019 | Novo artigo sobre [Aplicativos da Web progressivos (PWAs) para o Analytics](/help/technotes/pwa.md). |
| 8 de agosto de 2019 | Novo artigo em [Totais de métricas calculadas](/help/components/calculated-metrics/cm-totals.md). |
| 8 de agosto de 2019 | Esclarecimento sobre os [dados de sessão com carimbo de data e hora habilitado](/help/admin/tools/manage-rs/edit-settings/general/timestamp-configuration.md). |
...
| 18 de julho de 2019 | Documentação sobre um novo modelo do Espaço de trabalho chamado [“Magento: Marketing &amp; Commerce”](/help/analyze/analysis-workspace/build-workspace-project/starter-projects.md) para o Analysis Workspace. Ele foi projetado especificamente para clientes de comércio eletrônico do Magento, mas qualquer varejista pode usá-lo para obter informações exclusivas sobre suas atividades de comércio. |
...
| 4 de junho de 2019 | Novo guia criado, chamado Transição de uma plataforma de análise de terceiros para o Adobe Analytics. |
...
| 17 de janeiro de 2019 | [Análise de coorte](/help/analyze/analysis-workspace/visualizations/cohort-table/cohort-analysis.md) — as principais melhorias na análise de coorte permitem:<ul><li>Aplicar uma inclusão de segmento e retornar métricas separadamente. </li><li>Mostrar churn em vez de retenção.</li><li>Mostrar tabelas de latência (tempo decorrido antes e depois de um evento de inclusão).</li><li>Personalizar a dimensão da coorte (para agrupar visitantes com base em uma eVar, e não apenas no tempo).</li><li>Executar um cálculo acumulado de coorte: calcule a retenção/abandono com base em um período anterior, não na coorte original. </li><li>Adicionar várias métricas nos campos de inclusão e retorno, bem como aplicar segmentos. (As métricas calculadas não são suportadas)</li></ul> |
...
| 17 de janeiro de 2019 | [Compatível com variáveis de vários valores no Attribution](/help/analyze/analysis-workspace/attribution/overview.md). Algumas dimensões no Analytics podem conter vários valores em um único hit, como listVars, a variável do produto, propriedades de lista ou eVars de merchandising. O Analysis Workspace permite aplicar o Attribution a qualquer um desses tipos de variáveis no nível de hit. |
