...
| Recurso | Descrição | [Início da implantação](releases.md) | [Disponibilidade geral](releases.md) |
| ----------- | ---------- | ------- | ---- |
| **A coleção de mídia de streaming: Enviar dados do Roku para o Edge Network do Adobe Experience Platform** | Agora, ao [instalar a Coleção de mídia de streaming com o Experience Platform Edge](https://experienceleague.adobe.com/pt-br/docs/media-analytics/using/implementation/edge-recommended/media-edge-sdk/implementation-edge), você pode usar o Adobe Experience Platform Roku SDK para enviar dados de mídia de streaming para o Adobe Experience Platform. |  | 12 de abril de 2024 |
