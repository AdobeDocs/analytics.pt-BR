---
title: Visualizar as notas de versão de 2026 do Adobe Analytics
description: Notas de versão do Analytics de 2026
...
# Notas de versão do Adobe Analytics de 2026
...
| **Detalhamento do painel**<br/> A área de soltar de um painel agora oferece o recurso adicional para [detalhar](/help/analyze/analysis-workspace/c-panels/panels.md#break-down-a-panel) (em vez de segmentar) um painel com base em uma dimensão. | 31 de março de 2026 | 31 de março de 2026 |
...
| Recurso e descrição | [Início da implantação](releases.md) | [Disponibilidade geral](releases.md) |
| ----------- | ------- | ---- |
| **Feeds de dados aprimorados** <br/>Os seguintes aprimoramentos agora estão disponíveis para os feeds de dados:<ul><li>Experiência do usuário aprimorada.</li><li>Nova experiência para criar e gerenciar modelos de coluna.</li><li>Agora é possível escolher quando criar um modelo de coluna para reutilização em feeds de dados futuros. Também é possível excluir, editar e copiar modelos.<br/>Anteriormente, cada feed de dados criado resultava em um novo modelo de coluna, o que gerava um grande número de modelos de coluna não utilizados, além de não ser possível excluí-los ou gerenciá-los.</li><li>Adicione e filtre por tags.</li><li>Exibir o histórico de trabalhos do feed de dados. (Quando o período de solicitação começou, terminou e assim por diante.)</li><li>Reenviar ou reprocessar feeds de dados. (Na página Histórico de trabalhos)</li><li>Permitir ocorrências de chegada tardia. Agora é possível incluir dados que chegaram depois que o trabalho do feed de dados terminou de processar dados dentro da frequência de relatório definida.</li><li>Ao escolher uma data final para um feed de dados, a data escolhida é incluída como o último dia do feed de dados.<br/>Anteriormente, a data final era excluída do feed de dados.</li><li>Uma frequência de exportação de 15 minutos agora é possível, mas não está disponível por padrão. Para que essa opção fique disponível em seu ambiente, primeiro entre em contato com o Atendimento ao cliente da Adobe e solicite que seu conjunto de relatórios faça exportações a cada 15 minutos.</li></ul><p>**Observação:** com essas melhorias, os URLs das páginas de feed de dados no Adobe Analytics também serão atualizados. Atualize todos os marcadores existentes para apontar para as novas páginas de feeds de dados até 30 de abril de 2026.</p><p>Para mais informações, consulte [Criar um feed de dados](/help/export/analytics-data-feed/create-feed.md) e [Gerenciar feeds de dados](/help/export/analytics-data-feed/df-manage-feeds.md).</p> | quarta-feira, 20 de janeiro de 2026 | 24 de fevereiro de 2026<p>(Lançamento planejado originalmente para 10 de fevereiro de 2026)</p> |
| **Novo Guia da API de conjuntos de relatórios do Adobe Analytics 2.0** <p>Criar, recuperar, atualizar e excluir APIs de conjuntos de relatórios. Para mais informações, consulte o [Guia de referência da API de conjuntos de relatórios do Adobe Analytics 2.0](https://developer.adobe.com/analytics-apis/docs/2.0/apis/report-suites/) e o [Guia de ponto de acesso da API de conjuntos de relatórios do Adobe Analytics 2.0](https://developer.adobe.com/analytics-apis/docs/2.0/guides/endpoints/report-suites/).</p> | | Fevereiro de 2026 |
| **Novo Guia de relatórios de detecção de anomalias da API do Adobe Analytics 2.0** <p>Criar um relatório de detecção de anomalias da API automatizado. Para mais informações, consulte o [Guia de ponto de acesso de relatórios da API de detecção de anomalias](https://developer.adobe.com/analytics-apis/docs/2.0/guides/endpoints/reports/anomaly/).</p> | | Fevereiro de 2026 |
| **Novo Guia de relatório básico de tendências por data da API do Adobe Analytics 2.0** <p>Criar um Relatório de KPI básico de tendências por data da API automatizado Para mais informações, consulte [Guia do ponto de acesso de relatórios da API de detecção de anomalias](https://developer.adobe.com/analytics-apis/docs/2.0/guides/endpoints/reports/kpi/).</p> | | Fevereiro de 2026 |
...
| Recurso e descrição | [Início da implantação](releases.md) | [Disponibilidade geral](releases.md) |
| ----------- | ------- | ---- |
| A funcionalidade <br/>[Construtor de regras](/help/components/classifications/sets/manage/rules.md) nos **Conjuntos de classificação** agora está disponível. É possível definir as regras no contexto de um conjunto de classificação. As regras são aplicadas (quando ativadas) a todos os conjuntos de relatórios e combinações de dimensões principais que estão inscritos no conjunto de classificação.</p> |  | sábado, 23 de janeiro de 2026 |
