...
| **Criação do conjunto de relatórios da API do Adobe Analytics 2.0** | Crie conjuntos de relatórios no Adobe Analytics com as APIs 2.0. O novo método POST substitui a criação da API do conjunto de relatórios 1.4 como preparação para a descontinuação futura das APIs 1.4. | | 15 de outubro de 2025 |
