...
| ----------- | ---------- | ---------- |
| **Atualização para pesquisas de dispositivo devido a dicas de clientes do Google** | 27 de fevereiro de 2023 | O uso de dicas do cliente, planejado para 16 de fevereiro de 2023, foi adiado para garantir melhor a qualidade das pesquisas de dispositivo usando dicas. Prosseguiremos com a primeira fase da versão para suporte do Client Hints em 27 de fevereiro de 2023. Se tudo correr bem, vamos prosseguir para a segunda e última fase do lançamento na quinta-feira, 2 de março de 2023. [Saiba mais](/help/technotes/client-hints.md) |
