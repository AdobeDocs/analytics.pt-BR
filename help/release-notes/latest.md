...
* Correção de um problema com arquivos de pesquisa System.tsv em Feed de dados.
* Correção de um problema com valores de métrica diferentes entre Reports &amp; Analytics e Workspace (AN-315965).
* Correção de um problema que impedia a importação de classificações parciais. (AN-315854)
* Correção de um problema com a API do Analytics 1.4. (AN-316475)
* Correção de um problema que impedia alguns clientes de obter classificações para a dimensão Página por meio do Report Builder e do Reports &amp; Analytics. (AN-314445)
...
| --- | --- | --- |
| **EOL do serviço de rastreamento de telefone de recursos japoneses** | 21 de março de 2023 | Somente para nossos clientes japoneses: Na **fim de maio de 2023**, o serviço de rastreamento de Telefone de recurso japonês (mod_ktrack) será descontinuado. Pedimos desculpas pelo incômodo, mas pedimos que você desinstale ou desative os módulos instalados em seu servidor Apache. Veja as páginas 27 e 28 pol. [este documento](/help/release-notes/mod_ktrackforSiteCatalyst_ver1.40.pdf) para referência. |
