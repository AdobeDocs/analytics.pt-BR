...
| **Guia de relatórios da API de modelo de atribuição** <br/>Um novo Guia de relatórios de modelo de atribuição da API 2.0 do Adobe Analytics está disponível. O guia aborda como incluir dados de objeto do modelo de atribuição nos relatórios da API de dimensões.<p>Para mais informações, consulte [modelos de atribuição da API de dimensões](https://developer.adobe.com/analytics-apis/docs/2.0/guides/endpoints/dimensions/attmodel).</p> | | Maio de 2026 |
