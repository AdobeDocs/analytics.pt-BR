...
| **Fim da vida útil do Data Workbench** | 14 de setembro de 2022 | Adobe pretende encerrar a vida útil do Data Workbench em **31 de dezembro de 2023**. Entre em contato com o representante do Atendimento ao cliente para obter soluções alternativas ao Data Workbench ou se tiver alguma dúvida. [Saiba mais](https://experienceleague.adobe.com/docs/data-workbench/using/eol.html?lang=pt-BR) |
