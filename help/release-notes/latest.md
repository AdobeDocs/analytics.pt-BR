...
| ----------- | ---------- | ---------- |
| Atualizações da região ISO 2022 | 11 de março de 2021 | O Adobe executará atualizações de 2022 na região ISO em 10 de junho de 2022. Você deve esperar pequenas atualizações após esta versão. |
