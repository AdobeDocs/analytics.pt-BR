...
| **Fluxo de trabalho aprimorado para migração do SDK da Web** | Agora, os fluxos de dados mapeiam automaticamente os campos do objeto de dados do SDK da Web diretamente para o Adobe Analytics. [Mapeamento de objeto de dados](/help/implement/aep-edge/data-var-mapping.md) é semelhante a [Mapeamento de objeto XDM](/help/implement/aep-edge/xdm-var-mapping.md), mas não requer um esquema XDM. Esse fluxo de trabalho aprimorado oferece os seguintes benefícios:<ul><li>Ele adia o requisito de usar um esquema até que você esteja pronto para enviar dados para a Adobe Experience Platform. Se um esquema fosse necessário neste estágio de uma migração de implementação, você seria forçado a usar um esquema com base em campos do Adobe Analytics. Os serviços da Adobe Experience Platform, como o Customer Journey Analytics, não têm um conceito de props ou eVars. Um esquema com foco no Analytics pode apresentar dificuldades se sua organização quiser usar seu próprio esquema no futuro.</li><li>Depois de fazer alterações de implementação no SDK da Web, sua organização estará em melhor posição para migrar do Adobe Analytics para o Customer Journey Analytics. Se você enviar dados para a Adobe Analytics usando o SDK da Web, não será necessário fazer alterações adicionais na implementação para enviar dados para a Adobe Experience Platform. Em vez disso, você pode usar o preparo de dados para mapear campos de objeto de dados para o esquema XDM.</li></ul>Consulte [Migração da extensão de tag do Adobe Analytics para a extensão de tag do SDK da Web](/help/implement/aep-edge/web-sdk/analytics-extension-to-web-sdk.md) e [Migração do AppMeasurement para o SDK da Web](../implement/aep-edge/web-sdk/appmeasurement-to-web-sdk.md) para obter mais informações. |  | Abril de 2024 |
...
| **Usar as mesmas contas de nuvem para [!UICONTROL Feeds de dados], [!UICONTROL Data Warehouse], e [!UICONTROL Conjuntos de classificações]** | As contas e os locais na nuvem que você criar agora poderão ser usados para exportar dados (com [!UICONTROL Feeds de dados] e [!UICONTROL Data Warehouse]) e importação de dados (com [!UICONTROL Conjuntos de classificações]).<p> **Alterações ao configurar contas:** Os usuários podem [Configurar contas de importação e exportação na nuvem](https://experienceleague.adobe.com/en/docs/analytics/components/locations/configure-import-accounts) e [Configurar locais de importação e exportação na nuvem](https://experienceleague.adobe.com/en/docs/analytics/components/locations/configure-import-locations) que podem ser utilizados para qualquer um dos seguintes fins:<ul><li>Importar dados com [!UICONTROL Conjuntos de classificações]</li><li>Exportar dados com [!UICONTROL Feeds de dados]</li><li>Exportar dados com [!UICONTROL Data Warehouse].</li></ul><p>**Alterações ao gerenciar contas e locais no [!UICONTROL Localizações] página**: os usuários podem usar o [Localizações](https://experienceleague.adobe.com/en/docs/analytics/components/locations/locations-manager) página (em [!UICONTROL Componentes] > Locações) para exibir e gerenciar todas as contas e locais que eles criam, independentemente de onde foram criados. <p>Anteriormente, a variável [!UICONTROL Localizações] página aplicada somente a contas que foram criadas para importação de dados com [!UICONTROL Conjuntos de classificações].</p>**Alterações ao gerenciar locais de [!UICONTROL Data Warehouse] ou [!UICONTROL Conjuntos de classificações]**<p>Ao gerenciar locais em uma determinada área de aplicação ([!UICONTROL Data Warehouse] ou [!UICONTROL Conjuntos de classificações]), somente os locais que foram criados nessa área de aplicativo específica estarão disponíveis. Por exemplo, ao visualizar a variável [!UICONTROL Data Warehouse] área de aplicação, somente [!UICONTROL Data Warehouse] locais estão disponíveis. Todas as contas ainda estão disponíveis em cada área de aplicativo, independentemente da área de aplicativo em que foram criadas. Anteriormente, todas as contas e locais estavam disponíveis em cada área de aplicativo, independentemente da área de aplicativo em que foram criados. Isso ainda é verdadeiro ao visualizar o [!UICONTROL Feeds de dados] área de aplicação. | | 17 de abril de 2024 |
