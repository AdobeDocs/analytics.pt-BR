...
>[!IMPORTANT]
>
>O conteúdo a seguir contém informações de pré-lançamento e está sujeito a alterações.
...
| ----------- | ---------- | ------- |
| Anotações no Workspace | As anotações no Workspace permitem que você comunique com eficácia nuances de dados contextuais e insights à sua organização. [Saiba mais](/help/analyze/analysis-workspace/components/annotations/overview.md) | 23 de março de 2022 |
| Atualizações da página de aterrissagem do Adobe Analytics | Atualizações na página de aterrissagem conjunta do Workspace/Reports &amp; Analytics que melhoram a utilização e facilitam a navegação. [Saiba mais](/help/analyze/landing.md) | 23 de março de 2022 |
