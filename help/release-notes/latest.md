...
| ----------- | ---------- | ------- | ---- |
| **Suporte para destinos seguros no novo Report Builder** | Novos destinos de exportação foram adicionados ao complemento do Report Builder. Os seguintes destinos de armazenamento na nuvem são compatíveis: <ul><li>Amazon S3 Role ARN</li><li>Google Cloud Platform</li><li>Azure SAS</li><li>Azure RBAC</li></ul> O FTP não é mais compatível devido a questões de segurança. (Link da documentação a seguir) |  | 19 de junho de 2025 (originalmente 18 de junho) |
