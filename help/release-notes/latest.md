...
**Última atualização**: terça-feira, 7 de julho de 2025
...
| ----------- | ---------- | ------- | ---- |
| **Campos TNT de Livestream com algoritmos** | Livestream está passando por uma atualização para garantir que a tecnologia continue a ser moderna e estável. Como parte dessa atualização, se o campo TNT tiver um algoritmo, começaremos a incorporar o campo TNT na saída do Livestream. No entanto, isso inclui apenas os elementos suportados anteriormente: `campaignId`, `recipeId`, `trafficType`, `actionId` e `actionName`. O esquema TNT geral para Livestream permanece inalterado. |   | Julho de 7,2025 |
