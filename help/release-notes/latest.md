...
| ----------- | ---------- | ---------- |
| **Atualização para pesquisas de dispositivo devido a dicas de clientes do Google** | 17 de fevereiro de 2023 | **O uso de dicas do cliente, planejado para 16 de fevereiro de 2023, foi adiado para garantir melhor a qualidade das pesquisas do dispositivo usando dicas. Comunicaremos uma nova data de lançamento em breve.** [Saiba mais](/help/technotes/client-hints.md) |
