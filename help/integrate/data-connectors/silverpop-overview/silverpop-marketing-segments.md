...
* **Perfil de abandono de formulário (opcional):** Incentivar os visitantes a concluírem um formulário não finalizado por campanhas projetadas especificamente para aqueles que iniciaram e não concluíram um formulário online. Esse segmento será criado somente se 2 eventos forem criados para inicializações de formulário e conclusões de formulários.
* **Perfil de download de arquivo (opcional):** Alcance os clientes potenciais por campanhas projetadas para os que mostraram interesse baixando um white paper ou outro tipo de download. Esse segmento só será criado se 1 evento for criado para downloads de arquivos bem-sucedidos.
