...
user-guide-description: Configure integrações com outras soluções da Adobe Experience Cloud, como Audience Manager e Advertising.
...
+ [Guia de integração do Analytics](home.md)
...
+ [Adobe Analytics para Advertising](https://experienceleague.adobe.com/docs/advertising-cloud/integrations/analytics/overview.html?lang=pt-BR)
