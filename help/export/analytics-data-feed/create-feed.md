...
1. Na seção [!UICONTROL **Informações do feed**], preencha os seguintes campos:
   ...
   | Campo | Função |
   |---------|----------|
   | [!UICONTROL **Nome**] | O nome do feed de dados. Deve ser único no conjunto de relatórios selecionado e deve ter até 255 caracteres. [Saiba mais](/help/export/analytics-data-feed/df-faq.md#must-feed-names-be-unique) |
   ...
   | [!UICONTROL **Feed contínuo**] | Essa caixa de seleção remove a data de término, permitindo que um feed seja executado indefinidamente. Quando um feed terminar de processar dados históricos, ele aguarda que os dados terminem de coletar por uma determinada hora ou dia. Quando a hora ou o dia atual terminar, o processamento será iniciado após o atraso especificado. |
...
1. Na seção [!UICONTROL **Destino**], no menu suspenso [!UICONTROL **Tipo**], selecione o destino para o qual deseja enviar os dados.
   ...
   Ao usar o Amazon S3 com Feeds de dados, somente a criptografia SSE-S3 é compatível.
   ...
   1. Caso ainda não o tenha feito, crie um aplicativo do Azure que o Adobe Analytics possa usar para autenticação e, em seguida, conceda permissões de acesso no controle de acesso (IAM).
      ...
      Para obter informações, consulte a [documentação do Microsoft Azure sobre como criar um aplicativo do Azure Ative Diretory](https://learn.microsoft.com/en-us/azure/active-directory/develop/howto-create-service-principal-portal).

   1. No Admin Console do Adobe Analytics, na seção [!UICONTROL **Destino**], no menu suspenso [!UICONTROL **Tipo**], selecione [!UICONTROL **Azure RBAC**].
   ...
   1. (Condicional) Se você não tiver adicionado anteriormente uma conta RBAC do Azure:
      ...
      1. Selecione [!UICONTROL **Adicionar conta**] e especifique as seguintes informações:
         ...
         | Campo | Função |
         |---------|----------|
         | [!UICONTROL **Nome da conta**] | Um nome para a conta RBAC do Azure. Este nome é exibido no campo suspenso [!UICONTROL **Selecionar conta**] e pode ser qualquer nome que você escolher. |
         | [!UICONTROL **Descrição da conta**] | Uma descrição para a conta RBAC do Azure. Esta descrição é exibida no campo suspenso [!UICONTROL **Selecionar conta**] e pode ser qualquer nome que você escolher. |
   ...
   1. No Admin Console do Adobe Analytics, na seção [!UICONTROL **Destino**], selecione [!UICONTROL **Azure SAS**].
   ...
   1. No Admin Console do Adobe Analytics, na seção [!UICONTROL **Destino**], selecione [!UICONTROL **Google Cloud Platform**].
...
* [!UICONTROL **Host**]: insira a URL de destino do FTP desejada. Por exemplo, `ftp://ftp.omniture.com`.
