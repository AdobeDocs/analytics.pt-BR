...
1. Na seção [!UICONTROL **Destino**], configure o destino para onde deseja que os dados sejam enviados.
   ...
   >
   >* A Adobe recomenda usar uma conta em nuvem para o destino do seu relatório. [Contas FTP e SFTP herdadas](/help/components/locations/configure-import-accounts.md) estão disponíveis, mas não são recomendadas.
