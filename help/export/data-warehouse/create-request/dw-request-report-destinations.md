...
1. (Condicional) Se você não tiver acesso a uma conta na nuvem já configurada no Adobe Analytics, será possível configurá-la:
   ...
   1. Na seção [!UICONTROL **Propriedades da conta**], insira as informações específicas do tipo de conta selecionado.
      ...
      **OBSERVAÇÃO:** ao usar o Amazon S3 com Feeds de Dados, Data Warehouse e Classificações, somente a criptografia SSE-S3 é suportada.
      ...
      >[!NOTE]
      >
      >Contas de email podem ser usadas somente com o Data Warehouse. (Contas de email sem suporte com [Feeds de dados](/help/export/analytics-data-feed/create-feed.md) ou [Conjuntos de classificação](/help/components/classifications/sets/overview.md)).
