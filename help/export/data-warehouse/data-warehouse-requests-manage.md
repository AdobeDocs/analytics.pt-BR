---
description: Saiba como visualizar, duplicar e repriorizar solicitações do Data Warehouse.
...
Você pode visualizar e gerenciar as solicitações do Data Warehouse que fez. Somente administradores podem visualizar e gerenciar solicitações feitas por outros usuários em suas organizações.
...
Para exibir solicitações do Data Warehouse:
...
Você pode visualizar o histórico de qualquer solicitação do Data Warehouse que tenha feito.

1. No Adobe Analytics, selecione [!UICONTROL **Ferramentas**] > [!UICONTROL **Data Warehouse**].

1. Na página do Data Warehouse, selecione a solicitação cujo histórico você deseja exibir.

   ![Gerenciar uma solicitação](assets/dw-manage-request.png)

1. Selecione [!UICONTROL **Exibir histórico**].

   A página [!UICONTROL **Exibir solicitação do Data Warehouse**] exibe uma lista de entregas de relatório individuais associadas à solicitação.
   ...
   | [!UICONTROL **ID da solicitação herdada**] | A ID usada para identificar um relatório na interface herdada do Data Warehouse. Essa ID pode ser necessária ao entrar em contato com o Atendimento ao cliente da Adobe. |
   | [!UICONTROL **ID do Relatório**] | A ID usada para identificar um relatório na interface atual do Data Warehouse. Essa ID pode ser necessária ao entrar em contato com o Atendimento ao cliente da Adobe. |
...
1. Na página do Data Warehouse, selecione a solicitação que deseja copiar.

   ![Gerenciar uma solicitação](assets/dw-manage-request.png)

1. Selecione [!UICONTROL **Copiar**].

   A página de solicitação Copiar Data Warehouse é exibida. Todas as opções de configuração são copiadas da solicitação original.
...
1. Selecione o ícone **Configurar colunas** no canto superior direito da página do Data Warehouse.
...
1. Selecione o ícone **Filtro** no painel esquerdo da página do Data Warehouse.
...
1. No campo de pesquisa na parte superior da página do Data Warehouse, especifique o nome da solicitação que deseja exibir.
