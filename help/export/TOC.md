...
+ Data Warehouse {#data-warehouse}
   ...
   + [Compatibilidade de segmentos do Data warehouse](data-warehouse/segment-compatibility.md)
...
+ [API do Adobe Analytics](https://developer.adobe.com/analytics-apis/docs/2.0/)
