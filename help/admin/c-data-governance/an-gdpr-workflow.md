...
<table id="table_0E561F62247A4D01B6E7180560082DC9"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p> Siga as instruções em <a href="/help/admin/c-data-governance/gdpr-setup-reportsuite.md">Rotular dados do conjunto de relatórios</a>. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col3"> <p>Como cliente do Adobe Analytics, você pode enviar solicitações individuais da Privacidade de dados para acessar e excluir dados do cliente, ao chamar a <a href="https://www.adobe.io/apis/cloudplatform/gdpr.html">API da Privacidade de dados da Adobe Experience Cloud</a>. </p> <p>É possível enviar qualquer identificador do Analytics (conforme descrito na seção <a href="/help/admin/c-data-governance/gdpr-analytics-ids.md">Práticas recomendadas de rotulagem</a>) nas solicitações, junto com suas respectivas IDs de namespace (IDs da fonte de dados). </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col3"> <p>Siga as instruções em <a href="/help/admin/c-data-governance/gdpr-view-settings.md"> Exibir configurações da governânça de dados do conjunto de relatórios</a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
--&gt;
