---
description: Cada ID que você deseja pesquisar recebe uma namespace, que é uma string personalizada que identifica essa ID em qualquer variável onde ela é usada em todos os seus conjuntos de relatórios.
title: Namespaces
...
Cada ID que você deseja pesquisar recebe uma namespace, que é uma string personalizada que identifica essa ID em qualquer variável onde ela é usada em todos os seus conjuntos de relatórios.
...
* Um campo &quot;namespace&quot; contendo a string de namespace.
* Um campo &quot;type&quot; que para a maioria das solicitações do Adobe Analytics contém o valor &quot;analytics&quot;.
* Um campo de &quot;valor&quot; que contém a ID que o Analytics deve procurar nas variáveis de namespace associadas de cada conjunto de relatórios.
...
O valor deve ser especificado como dois números hexadecimais separados por um traço. Todos os dígitos hexadecimais que são caracteres alfabéticos devem ser especificados usando maiúsculas e minúsculas. Os valores hexadecimais não devem ter zeros à esquerda (observe a diferença do mesmo valor especificado no formulário obsoleto, onde os zeros à esquerda são obrigatórios).
...
O valor deve ser especificado como dois números hexadecimais de 16 dígitos ou como dois números decimais de 19 dígitos. Os números devem ser separados por um travessão, um sublinhado ou dois pontos. Zeros à esquerda devem ser adicionados se um dos dois números não tiver dígitos suficientes.
...
A namespace também é predefinida para a ID de visitante personalizada.
...
Você também pode ver namespaces previamente definidas para outras variáveis ou conjuntos de relatórios e reutilizar uma dessas variáveis, para que a mesma namespace possa ser usada facilmente para todos os conjuntos de relatórios que armazenam esse tipo de ID. Também é possível atribuir a mesma namespace a várias variáveis em um conjunto de relatórios. Por exemplo, alguns clientes armazenam uma ID CRM em uma variável de tráfego e uma variável de conversão (dependendo da página, ela às vezes está em uma ou na outra ou ambas), e eles podem atribuir a namespace &quot;ID CRM&quot; a ambas as variáveis.
