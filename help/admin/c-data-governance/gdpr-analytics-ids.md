...
>[!NOTE]
>
>As props sempre não distinguem maiúsculas de minúsculas. As eVars não diferenciam maiúsculas de minúsculas por padrão, mas podem ser configuradas pelo Atendimento ao cliente da Adobe para fazer essa diferenciação. Se você tiver uma eVar com distinção entre maiúsculas e minúsculas que contenha uma ID, é sua responsabilidade usar as letras maiúsculas e minúsculas corretas ao enviar uma solicitação de privacidade de dados para que as letras maiúsculas e minúsculas usadas na solicitação correspondam às letras maiúsculas e minúsculas usadas nas ocorrências que contêm essas IDs.
