...
1. No campo **Novas exibições da página diárias esperadas**, especifique o total de exibições diárias esperado para a página com o novo nível de tráfego.

   Certifique-se de especificar o número total de visualizações da página, não apenas as visualizações adicionais da página.
1. No campo **Data efetiva**, especifique a data em que espera que o novo nível de tráfego tenha início e, em seguida, clique em **[!UICONTROL Enviar]**.

   >[!NOTE]
   >
   >Para agendar um aumento permanente do tráfego, inclua um número de telefone nas informações de contato do usuário para que a Adobe possa contatá-lo com perguntas, se necessário.
