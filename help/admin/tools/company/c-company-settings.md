...
+ Compartilhamento de marcas: a página Gerenciar compartilhamento de marcas permite exibir o logotipo da empresa nos relatórios e na interface do usuário. Clique em **[!UICONTROL Habilitar compartilhamento de marcas]**.
...
+ Otimização do desempenho na China: a Otimização do desempenho da Adobe na China continental permite que os clientes da China enviem dados diretamente para o nó de borda da China, em vez de outros locais globalmente. Isso melhora os tempos de carregamento de página e a precisão dos dados em comparação ao envio de dados para nós fora da China. Consulte a seção de perguntas frequentes na interface do usuário para obter mais informações.