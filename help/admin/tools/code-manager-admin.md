...
## Descrições da página do Gerenciador de código {#section_7C317BB0287A4B8EB0A1A4ECC40627BF}

| Coluna | Descrição |
|--- |--- |
| [!UICONTROL Nome] | O nome corresponde à plataforma na qual você deseja ativar a coleta de dados. As bibliotecas nativas são fornecidas para cada plataforma listada nesta coluna. |
| [!UICONTROL Tipo] | Tipos de aplicativos que podem ser medidos usando cada biblioteca. |
| [!UICONTROL Versão] | Liste a versão mais recente da biblioteca. Clique no número da versão para exibir o [histórico das versões](/help/implement/appmeasurement-updates.md). |
| [!UICONTROL Documentação] | Exibir a documentação de referência da biblioteca. |
