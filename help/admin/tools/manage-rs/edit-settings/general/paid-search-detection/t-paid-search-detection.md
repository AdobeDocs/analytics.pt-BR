...
1. Na página [!UICONTROL Detecção de pesquisa paga], configure os campos descritos em [Detecção de pesquisa paga - Descrições](/help/admin/tools/manage-rs/edit-settings/general/paid-search-detection/paid-search-detection.md#section_0C2CFA0AF77B47098BE37CB024665D0D).
