---
description: As classificações de tráfego permitem classificar variáveis de tráfego (props). As classificações de tráfego podem usar somente classificações de texto.
...
As classificações de tráfego permitem classificar variáveis de tráfego (props). As classificações de tráfego podem usar somente classificações de texto.

## Classificações de tráfego

As classificações de tráfego permitem classificar variáveis de tráfego (props). As classificações de tráfego podem usar somente classificações de texto.

A página Classificações de tráfego permite criar classificações para os conjuntos de relatórios selecionados. Depois de classificado, qualquer relatório que você gerar usando os dados principais também poderá ser gerado usando os atributos associados.
