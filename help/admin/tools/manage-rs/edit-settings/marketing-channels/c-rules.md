...
* Crie um ou mais canais para poder atribuir regras a eles. Consulte [Adicionar canais de marketing](/help/admin/tools/manage-rs/edit-settings/marketing-channels/c-channels.md).
...
Consulte [Motivos para interno (Atualização de sessão)](/help/components/c-marketing-channels/c-faq.md#internal) para obter mais informações sobre por que esse canal ocorre.
