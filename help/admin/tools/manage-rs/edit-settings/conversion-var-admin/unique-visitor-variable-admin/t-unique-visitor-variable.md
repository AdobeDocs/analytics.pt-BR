...
Você pode designar qual eVar contém seu identificador de visitante.
...
Para designar qual eVar contém seu identificador de visitante:
...
1. Marque a caixa de seleção **[!UICONTROL eVars disponíveis]** para habilitar a lista suspensa.
