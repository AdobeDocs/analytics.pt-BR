...
| [!UICONTROL Redefinir] | Redefine qualquer valor existente no eVar. Use essa configuração ao redefinir o objetivo de uma eVar para que você não misture um valor antigo em um novo relatório. A redefinição não apaga dados históricos. |
