...
Esta tabela lista todos os itens de permissões em Ferramentas de conjunto de relatórios ao configurar um perfil de produto no Adobe Admin Console. Esses itens de permissão se aplicam somente aos conjuntos de relatórios incluídos no mesmo perfil de produto. Se o perfil de produto atual não contiver conjuntos de relatórios, a inclusão dessas permissões não fará nada.
...
| [!UICONTROL Relatório de Canal] | Não usado. |
...
| [!UICONTROL Visitas de Retorno Diário] | Não usado. |
...
| [!UICONTROL Reportlet de Teste do Painel de R&amp;A] | Não usado. |
| [!UICONTROL Reportlet de Resumo de Uso do Painel de R&amp;A] | Não usado. |
