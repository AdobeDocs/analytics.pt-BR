...
| [!UICONTROL Páginas de bot] | Concede acesso a Métricas do site > Bots > Relatório de páginas de bot no Reports &amp; Analytics. |
| [!UICONTROL Bots] | Concede acesso a Métricas do site > Bots > Relatórios de bots no Reports &amp; Analytics. |
| [!UICONTROL Relatório de Canal] | Concede acesso a Canais de marketing > Relatório de visão geral do canal no Reports &amp; Analytics. |
...
| API de [!UICONTROL reparo de dados] | Concede acesso à API de reparo de dados |
...
| [!UICONTROL Meus relatórios recomendados] | Concede acesso a Métricas do site > Meus relatórios recomendados no Reports &amp; Analytics. |
