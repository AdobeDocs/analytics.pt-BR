...
| [!UICONTROL Acesso à Interface do Usuário das Ferramentas Administrativas] | Não usado. |
...
| [!UICONTROL Acesso à Interface de Usuário de Configurações da Empresa] | Não usado. |
| [!UICONTROL Migração de componentes] | Concede acesso a Administrador > Migração de componentes. |
| [!UICONTROL Dados atuais] | Não usado. |
| [!UICONTROL Acesso à interface do usuário da Rotulagem de Privacidade e Governança de Dados] | Concede acesso a Administração > Rotulagem de Privacidade de governança de dados. |
...
| [!UICONTROL Acesso ao Labs] | Fornece aos usuários acesso aos laboratórios e aos protótipos no Labs. |
| [!UICONTROL Report Builder legado] | Permite que o usuário se autentique com o complemento Herdado do Report Builder no Microsoft Excel. |
...
| [!UICONTROL Acesso ao MCP] | Concede acesso para usar o [servidor MCP do Adobe Analytics](https://developer.adobe.com/analytics-mcp/docs/aa/). Esse item de permissão é necessário para todos os usuários, incluindo administradores de produtos, para usar essa ferramenta. |
...
| [!UICONTROL Acesso à interface do administrador dos conjuntos de relatórios] | Concede acesso a Administração > Conjuntos de relatórios, mas não permite acesso para editar configurações ou criar conjuntos de relatórios. Use os [itens de permissão das ferramentas do conjunto de relatórios](report-suite-tools.md) para permitir seletivamente que os usuários editem as configurações do conjunto de relatórios. |
| [!UICONTROL Acesso à interface do usuário do Gerenciador de Atividades de Relatórios] | Concede acesso a Administração > Gerente de atividades de relatórios. |
