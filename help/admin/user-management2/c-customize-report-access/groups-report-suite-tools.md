...
**[!UICONTROL Gerenciamento]** de usuários &gt; **[!UICONTROL Grupos]** &gt; Acesso **[!UICONTROL a]** relatórios &gt; Ferramentas **[!UICONTROL do conjunto de]** relatórios &gt; **[!UICONTROL Personalizar]**
...
| Data Warehouse | Permite que um usuário não administrador faça chamadas usando os métodos do Data Warehouse por meio da API de serviços da Web. See [Data Warehouse - Developer Documentation](/help/export/data-warehouse/data-warehouse.md) |
...
| [Personalização de menu](/help/admin/admin/customize-menus.md) | Personalize os menus de relatório que o usuário vê em Reports &amp; Analytics. |
