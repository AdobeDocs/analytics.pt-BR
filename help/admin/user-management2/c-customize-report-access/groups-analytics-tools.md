...
| [Dados atuais](https://experienceleague.adobe.com/docs/analytics/analyze/reports-analytics/current-data.html?lang=pt-BR) | Concede permissão para uso do recurso Dados atuais nos relatórios. |
...
| Acesso à [Analysis Workspace](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/home.html?lang=pt-BR) | Concede aos usuários acesso à Analysis Workspace, a interface de relatórios recomendada para o [!DNL Adobe Analytics]. |
| [Reports &amp; Analytics](/help/analyze/reports-analytics/getting-started.md) | Concede aos usuários acesso ao Reports &amp; Analytics. |
...
| [Criação de segmentos](https://experienceleague.adobe.com/docs/analytics/components/segmentation/seg-home.html?lang=pt-BR) | Concede aos usuários permissão para criar segmentos. |
| **Data Connectors** |  |
