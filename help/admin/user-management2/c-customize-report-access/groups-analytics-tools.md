...
**[!UICONTROL Gerenciamento de usuários]** &gt; **[!UICONTROL Grupos]** &gt; **[!UICONTROL Acesso ao Relatório]** &gt; **[!UICONTROL Ferramentas do Analytics]** &gt; **[!UICONTROL Personalizar]**

>[!NOTE]
>
>A versão lançada no último trimestre de 2016 (20 de outubro) trouxe alterações para o gerenciamento de grupos. See [Administrative Changes - Fall 2016](../../../admin/user-management2/c-user-management/permissions-changes.md#concept_86581595B86B47D5B8F90282FC3E31EF) for a summary of changes.
...
|--- |--- |
| **Geral** |  |
| [Faturamento](../../../admin/admin/billing-admin.md) | Permite acessar informações de faturamento, inclusive detalhes de tráfego, para cada conjunto de relatórios. |
...
| [ClickMap](https://marketing.adobe.com/resources/help/en_US/sc/user/clickmap.html) | Exibe ClickMap no menu [!UICONTROL Ferramentas], no cabeçalho.<br>(**Observação:** a Adobe recomenda o uso do [Activity Map](https://marketing.adobe.com/resources/help/en_US/analytics/activitymap/activitymap-enable.html).) |
...
| [Criar/preparar projetos](https://marketing.adobe.com/resources/help/en_US/analytics/analysis-workspace/curate.html) na Analysis Workspace | Concede aos usuários permissão para criar e preparar projetos na Analysis Workspace. |
