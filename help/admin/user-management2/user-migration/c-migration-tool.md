...
Depois de migrar, você pode [gerenciar usuários e produtos da Experience Cloud](https://docs.adobe.com/content/help/en/core-services/interface/manage-users-and-products/admin-getting-started.html) no Admin Console.
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    ...
    </ul> <p>Esses recursos permanecerão disponíveis para você no gerenciamento de usuários do Analytics. </p> <p>Consulte <a href="/help/admin/user-management2/user-migration/c-migration-tool/c-migration-tool.md">Recursos do Analytics não suportados no Admin Console</a> para obter mais informações. </p> </td> 
  </tr> 
  <tr> 
