...
É possível personalizar os menus de relatório que um usuário vê no Reports &amp; Analytics. É possível exibir ou ocultar relatórios, bem como movê-los em pastas diferentes para todos os usuários. Esse recurso é útil principalmente se a sua organização utiliza apenas determinados relatórios e não deseja encher o menu esquerdo com dados não utilizados ou irrelevantes.
...
Para personalizar os menus que os usuários veem no Reports &amp; Analytics:
