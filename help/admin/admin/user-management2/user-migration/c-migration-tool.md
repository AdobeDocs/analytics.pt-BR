...
<table id="table_36FD7EF1DAB44D359F4FC186D93147E5"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <p>Importante: atualize sua instalação do <a href="https://experienceleague.adobe.com/pt-br/docs/analytics/analyze/report-builder/report-builder-setup">Report Builder</a> para a versão mais recente. </p> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Sim. Entretanto, a Adobe recomenda que você use o tempo antes do início da migração para: </p> 
    ...
    </ul> <p>Para acelerar sua migração, entre em contato com a equipe de conta do Adobe em <a href="https://helpx.adobe.com/br/marketing-cloud/contact-support.html"> Adobe Atendimento ao cliente</a> e envie um pedido para antecipar a data de início da migração. </p> </td> 
  </tr> 
  <tr> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    ...
    </ul> <p>Esses recursos permanecerão disponíveis para você no gerenciamento de usuários do Analytics. </p> <p>Consulte <a href="/help/admin/admin/user-management2/user-migration/c-migration-tool.md">Recursos do Analytics não compatíveis com o Adobe Admin Console</a> para obter mais informações. </p> </td> 
  </tr> 
  <tr> 
