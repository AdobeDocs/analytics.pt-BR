...
Para obter mais informações sobre rótulos de Governança de dados, consulte [Rótulos da Privacidade de dados para variáveis do Analytics](/help/admin/admin/c-data-governance/data-labeling/gdpr-labels.md).
