...
* 25 meses de retenção máxima.  Você pode revisar suas configurações atuais de retenção de dados em [!UICONTROL Analytics] > [!UICONTROL Administrador] > [!UICONTROL Governança de dados].  [Retenção de dados](https://experienceleague.adobe.com/pt-br/docs/analytics/technotes/data-retention)
...
* Escopo limitado. O escopo do cookie deve ser limitado a um único site ou aplicativo. [Cookies do navegador](https://experienceleague.adobe.com/pt-br/docs/analytics/technotes/cookies/cookies#third-party-cookie-limitations)
...
* Capacidade de acesso e exclusão. Utilize o Privacy Service para acessar e excluir solicitações. [Analytics e Privacy Service](https://experienceleague.adobe.com/pt-br/docs/experience-platform/privacy/regulations/overview)
