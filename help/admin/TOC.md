...
product: analytics
audience: admin
user-guide-title: Guia do administrador do Analytics
...
+ [Ajuda do administrador do Analytics](home.md)
...
+ Ferramentas administrativas {#admin-tools}
   ...
   + Regras de processamento {#processing-rules}
      ...
      + [Dimensões disponíveis para regras de processamento](admin/c-processing-rules/processing-rule-dimensions.md)
      + Processing rules examples {#processing-rules-examples}
         ...
         + [Preencher uma ID de campanha a partir de um parâmetro da string de consulta](admin/c-processing-rules/processing-rules-examples/processing-rules-populate-campaign-id.md)
         + [Definir o evento de exibição do produto na página de visão geral do produto](admin/c-processing-rules/processing-rules-examples/setting-the-product-view-event.md)
         + [Adicione uma subcategoria concatenando a categoria e o nome da página](admin/c-processing-rules/processing-rules-examples/subcategory-concatenating.md)
         + [Determine um caminho copiando um valor de evar para uma prop](admin/c-processing-rules/processing-rules-examples/processing-rules-determining-path.md)
         + [Limpar valores em um relatório](admin/c-processing-rules/processing-rules-examples/clean-up-values-in-a-report.md)
         + [Preencher termos de pesquisa interna usando um parâmetro da string de consulta](admin/c-processing-rules/processing-rules-examples/processing-rules-populating-internal-search.md)
      ...
      + [Dicas e truques de regras de processamento](admin/c-processing-rules/processing-rules-tips.md)
   + Real-time reports {#real-time-reports}
      ...
      + [Métricas e dimensões em tempo real suportadas](admin/realtime/realtime-metrics.md)
   + [Fila de relatórios agendados](admin/scheduled-reports-admin.md)
   + Server-side forwarding {#server-side-forwarding}
      ...
      + [Requisitos para encaminhamento pelo lado do servidor](admin/c-server-side-forwarding/ssf-requirements.md)
      + [Referência de código e dados de encaminhamento pelo lado do servidor](admin/c-server-side-forwarding/ssf-reference.md)
   ...
   + [Menu de relatórios simplificados](admin/t-simplified-menu.md)
   ...
   + Eventos bem-sucedidos {#success-events}
      ...
      + [Sobre a alteração do tipo de evento](admin/c-success-events/event-type.md)
...
+ Manage report suites {#manage-report-suites}
   ...
   + [Conjuntos de relatórios globais e de rollup](c-manage-report-suites/rollup-report-suite.md)
   ...
   + Report suite templates {#report-suite-templates}
      ...
      + [Portal do Aggregator](c-manage-report-suites/c-report-suite-templates/aggregator-portal.md)
      ...
      + [Portal de tarefas](c-manage-report-suites/c-report-suite-templates/job-portal.md)
   ...
   + New report suite {#new-report-suite}
      ...
      + [Novo conjunto de relatórios - configurações](c-manage-report-suites/c-new-report-suite/new-report-suite.md)
...
+ User and Product Management (Legacy) {#user-product-management}
   ...
   + Gerenciamento do usuário {#user-management}
      ...
      + [Mudanças de permissão do usuário e grupo](user-management2/c-user-management/permissions-changes.md)
   ...
   + Customize report access {#customize-report-access}
      ...
      + [Personalizar permissões de ferramentas do Conjunto de relatórios](user-management2/c-customize-report-access/groups-report-suite-tools.md)
      + [Personalizar permissões de métrica](user-management2/c-customize-report-access/groups-metrics.md)
      + [Personalizar permissões de dimensão](user-management2/c-customize-report-access/groups-dimensions.md)
...
+ Governança de dados {#data-governance}
   ...
   + [Fluxo de trabalho do Adobe Analytics RGD](c-data-governance/an-gdpr-workflow.md)
   + [Exibir/gerenciar configurações de gerenciamento de dados do conjunto de relatórios](c-data-governance/gdpr-view-settings.md)
   + [Rotular dados do conjunto de relatórios](c-data-governance/gdpr-setup-reportsuite.md)
   + [Enviar acesso e excluir solicitações](c-data-governance/gdpr-submit-access-delete.md)
   + [Rótulos RGPD para variáveis do Analytics](c-data-governance/gdpr-labels.md)
   + [Namespaces](c-data-governance/gdpr-namespaces.md)
   + [Expansão da ID](c-data-governance/gdpr-id-expansion.md)
   + [Rotular práticas recomendadas](c-data-governance/gdpr-analytics-ids.md)
   + [Exemplo de rótulo](c-data-governance/gdpr-labeling-example.md)
...
+ Uso de chamadas do servidor {#server-call-usage}
   ...
   + [Exibir o uso da chamada atual do servidor](c-server-call-usage/server-call-usage-dashboard.md)
   + [Exibir uso do conjunto de relatórios](c-server-call-usage/report-suite-usage.md)
   + [Alertas de uso de chamada do servidor](c-server-call-usage/scu-alerts.md)
   + [Perguntas frequentes sobre uso de chamadas do servidor](c-server-call-usage/overage-faq.md)
