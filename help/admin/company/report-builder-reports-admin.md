...
Você pode conceder acesso ao Report Builder a qualquer usuário do [!DNL Analytics], basta adicioná-lo ao grupo de acesso do Report Builder (**[!UICONTROL Analytics]** > **[!UICONTROL Administração]** > **[!UICONTROL Gerenciamento de usuários]** > **[!UICONTROL Grupos]**).
