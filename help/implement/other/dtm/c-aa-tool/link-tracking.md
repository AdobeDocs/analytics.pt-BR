...
**[!UICONTROL Propriedade]** > ![Ícone de engrenagem](assets/settings_gear.png) **[!UICONTROL Ferramenta de edição]** > **[!UICONTROL Rastreamento de link]**
...
<table id="table_F23FB0B284E74B66A107B1D69D22A51C">
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Determina se os dados do mapa de cliques do visitante estão reunidos. </p> <p>Consulte <a href="../../../vars/config-vars/trackinlinestats.md">trackInlinestats</a>. </p> </td>
  </tr>
  <tr>
   <td colname="col1"> Rastrear os links de download </td>
   <td colname="col2"> <p>Rastreie links para arquivos do site que podem ser baixados. </p> <p>Consulte <a href="../../../vars/config-vars/trackdownloadlinks.md">trackDownloadLinks</a>.</p> </td>
  </tr> 
  <tr> 
