...
>[!NOTE] Esse plug-in não substitui eVars que já existem em uma entrada de produto. Ele anexa apenas valores que você define usando o plug-in. Tenha cuidado ao anexar eVars que já existem para esse produto.
