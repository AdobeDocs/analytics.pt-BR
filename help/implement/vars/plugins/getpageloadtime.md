...
>[!IMPORTANT]
>
>Este plug-in não é mais suportado. Seu código utiliza o método performance.timing, que (de acordo com o MDN) foi [obsoleto](https://developer.mozilla.org/en-US/docs/Web/API/PerformanceTiming).
