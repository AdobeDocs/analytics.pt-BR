...
>[!IMPORTANT]
>
>A Adobe recomenda não usar essa variável. Em vez disso, use o [Serviço de ID de Visitante da Adobe](https://experienceleague.adobe.com/pt-br/docs/id-service/using/home).
