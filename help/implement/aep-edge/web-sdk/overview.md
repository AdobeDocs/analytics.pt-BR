...
Você pode usar o [SDK da Web da Adobe Experience Platform](https://experienceleague.adobe.com/docs/experience-platform/web-sdk/home.html?lang=pt-BR) para enviar dados ao Adobe Analytics. Há dois métodos principais para implementar o Web SDK, e cada método tem dois tipos de implementação:
