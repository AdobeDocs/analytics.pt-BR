...
1. Defina as variáveis do Analytics com os mesmos valores que foram configurados na extensão do Analytics.
   ...
   * As variáveis de configuração e chamadas de método do Analytics no código personalizado podem exigir lógica de implementação modificada. Consulte cada [variável](/help/implement/vars/overview.md) respectiva para determinar como atingir seu equivalente usando o SDK da Web.
