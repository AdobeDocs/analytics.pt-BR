...
+ Revisar sua implementação {#review}
   + [Revisão de implementação secundária (após cada lançamento de site)](review/minor-review.md)
   + [Principais revisões de implementação (a cada 6 meses)](review/major-review.md)
