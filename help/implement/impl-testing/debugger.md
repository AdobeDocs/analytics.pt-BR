...
O Edge não tem a capacidade de criar manualmente um bookmarklet, mas um URL do marcador pode ser editado.
...
O Safari não tem a capacidade de criar manualmente um bookmarklet, mas um URL do marcador pode ser editado.
...
* **Formato amigável:** alterna o formato de exibição entre rótulos úteis e cadeias de consulta brutas em uma solicitação de imagem. Consulte [Parâmetros de consulta de coleta de dados](../js-implementation/data-collection/query-parameters.md) para obter mais informações.
