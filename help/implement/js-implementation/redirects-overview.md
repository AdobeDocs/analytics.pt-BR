...
Essas variáveis serão representadas como os seguintes parâmetros no [Experience Cloud Debugger](https://marketing.adobe.com/resources/help/pt_BR/experience-cloud-debugger/).
