...
1. **Usar a coleta de dados do Adobe Experience Platform para mapear objetos de camada de dados para elementos de dados**: Crie elementos de dados na Coleta de dados do Adobe Experience Platform e mapeie-os para os atributos JavaScript descritos na camada de dados.
