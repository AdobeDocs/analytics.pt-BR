...
<table id="table_91790388C2DE4C5E8AEF0B9981AFFE27"> 
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> Use as regras de processamento para simplificar a coleta de dados e o gerenciamento do conteúdo conforme é enviado para os relatórios. <a href="https://marketing.adobe.com/resources/help/pt_BR/reference/processing_rules.html" format="https" scope="external"> [Mais...] </a> </td> 
  </tr> 
  <tr> 
   <td> Qual é a versão mais recente do arquivo s_code? </td> 
   <td> Esta seção contém um histórico das versões das bibliotecas do [!DNL AppMeasurement] nas plataformas da Web e dispositivos móveis. A versão mais recente de cada biblioteca pode ser baixada em Reports &amp; Analytics &gt; Ferramentas administrativas &gt; Gerenciador de código. <a href="https://marketing.adobe.com/resources/help/pt_BR/sc/appmeasurement/release/c_release_notes_javascript.html" format="http" scope="external"> [Mais...] </a> </td> 
  </tr> 
  <tr> 
   <td> Como depurar o arquivo s_code? </td> 
   <td> O Adobe Debugger (anteriormente chamado DigitalPulse Debugger) é uma ferramenta gratuita oferecida pela Adobe, que permite a visualização dos dados coletados em seu site em qualquer página específica. <a href="https://marketing.adobe.com/resources/help/pt_BR/sc/implement/debugger.html" format="http" scope="external"> [Mais...] </a> </td> 
  </tr> 
  <tr> 
   <td> Como rastrear diferentes tipos de links? </td> 
   <td> É possível rastrear automaticamente os downloads de arquivo e links de saída com base nos parâmetros definidos no arquivo AppMeasurement para JavaScript. <a href="https://marketing.adobe.com/resources/help/pt_BR/sc/implement/function_tl.html" format="http" scope="external"> [Mais...] </a> </td> 
  </tr> 
  <tr> 
   <td> Como rastrear vídeos? </td> 
   <td> O JavaScript pode ser utilizado para rastrear vários reprodutores. Para rastrear com o JavaScript, basta adicionar o código à página da Web que contém o reprodutor o rastreá-lo utilizando manipuladores de evento. <a href="https://marketing.adobe.com/resources/help/pt_BR/sc/appmeasurement/video/video_js.html" format="http" scope="external"> [Mais...] </a> </td> 
  </tr> 
  <tr> 
   <td> Como rastrear um aplicativo para dispositivos móveis? </td> 
   <td> É possível gerar links de aquisição com códigos de rastreamento exclusivos no Adobe Mobile Services. Quando um usuário baixa e executa um aplicativo da Apple App Store depois de clicar em um link gerado, o SDK coleta e envia automaticamente os dados de aquisição para o Adobe Mobile Services. <a href="https://marketing.adobe.com/resources/help/pt_BR/mobile/ios/acquisition.html" format="http" scope="external"> iOS</a> <a href="https://marketing.adobe.com/resources/help/pt_BR/mobile/android/acquisition.html" format="http" scope="external">Android </a> </td> 
  </tr> 
  <tr> 
   <td> Como implementar o rastreamento de vídeo? </td> 
   <td> É possível rastrear reprodutores de mídia ao criar funções vinculadas aos manipuladores de evento do reprodutor de vídeo. Isso permite chamar Media.open, Media.play, Media.stop e Media.close no momento certo. <a href="https://marketing.adobe.com/resources/help/pt_BR/sc/appmeasurement/video/video_js_events.html" format="http" scope="external"> [Mais...] </a> </td> 
  </tr> 
  <tr> 
   <td> Como configurar o cookie primário? </td> 
   <td> O Analytics usa cookies para fornecer informações sobre variáveis e componentes que não persistem entre as solicitações de imagem e as sessões do navegador. Esses cookies inofensivos são originários de um domínio hospedado pela Adobe, conhecidos como cookies de terceiros. <a href="https://marketing.adobe.com/resources/help/en_US/whitepapers/first_party_cookies/fpcookies_cert.html" format="http" scope="external"> [Mais...] </a> </td> 
  </tr> 
  <tr> 
   <td> Como posso obter um certificado SSL? </td> 
   <td> Determine se seu site usa o protocolo https://. Se o fizer, é necessário solicitar um CSR e comprar um certificado SSL. Observação: não é necessário um certificado SSL se você não tem páginas ou conteúdos seguros. Esta etapa pode ser ignorada se você só usar somente o protocolo https:// no site. <a href="https://marketing.adobe.com/resources/help/en_US/whitepapers/first_party_cookies/fpcookies_cert.html" format="http" scope="external"> [Mais...] </a> </td> 
  </tr> 
  <tr> 
   <td> Onde encontro informações sobre o aviso de expiração da certificação? </td> 
   <td> Os certificados SSL expiram anualmente, o que significa que a Adobe exige uma solicitação de certificado atualizada sempre que isso acontece. O especialista FPC fornece os avisos necessários quando isso ocorre, no entanto, recomenda-se ser proativo no monitoramento da validade e no fornecimento à Adobe deste certificado atualizado. <a href="https://marketing.adobe.com/resources/help/en_US/whitepapers/first_party_cookies/fpcookies_renewals.html" format="http" scope="external"> [Mais...] </a> </td> 
  </tr> 
  <tr> 
   <td> O que são plug-ins? </td> 
   <td> Os plug-ins do AppMeasurement para JavaScript são programas ou funções que executam várias funções avançadas. Esses plug-ins estendem a capacidade de seu arquivo JavaScript para fornecer a você mais funcionalidade do que a disponível com a implementação básica. A Adobe oferece diversos outros plug-ins como parte das soluções avançadas. Entre em contato com seu gerente de conta se você quiser capturar dados usando o JavaScript, mas se não tiver certeza sobre como proceder. <a href="https://marketing.adobe.com/resources/help/pt_BR/sc/implement/impl_plugins.html" format="http" scope="external"> [Mais...] </a> </td> 
  </tr> 
  <tr> 
   <td> Informações sobre a API de inserção dos dados? </td> 
   <td> A Adobe criou várias maneiras de enviar dados para o Analytics. <a href="https://marketing.adobe.com/resources/help/pt_BR/reference/usecase_sending_data_to_sc.html" format="http" scope="external"> [Mais...] </a> </td> 
  </tr> 
  <tr> 
   <td> O que é um erro 500? </td> 
   <td> Informações sobre o erro do servidor interno que causou um status "Erro de consulta 500". <a href="https://marketing.adobe.com/resources/help/pt_BR/sc/implement/pageType.html" format="http" scope="external">Consulte a variável pageType</a> </td> 
  </tr> 
 </tbody> 
</table>
...
| Dynamic Tag Management - por que minha regra de DTM não é acionada? | Se a sua regra baseada em eventos não é ativada, provavelmente há um problema com o seletor ou condição da regra. Localize o elemento em seu site em que a ação do evento desejado ocorre, clique com o botão direito do mouse e selecione Inspecionar elemento. Inspecione o script realçado na caixa que é aberta e verifique se você está direcionando o elemento correto.  [Mais em...](https://docs.adobe.com/content/help/pt-BR/dtm/using/admin/c-troubleshooting.html) |
| Como implementar o rastreamento de Video Heartbeat? | [Esta seção](https://docs.adobe.com/content/help/pt-BR/media-analytics/using/media-overview.html) contém instruções para baixar os SDKs do Video Heartbeat e guias do desenvolvedor para a sua plataforma. Ao baixar o SDK, baixe também o guia do desenvolvedor localizado na página de documentos, pois ele contém instruções de implementação específicas para o Vídeo Heartbeat. |
...
| Como depurar o arquivo s_code? | O Experience Cloud Debugger é uma ferramenta gratuita oferecida pela Adobe, que permite a visualização dos dados coletados em seu site em qualquer página. [Mais em...](https://docs.adobe.com/content/help/pt-BR/analytics/implementation/testing-and-validation/debugger.html) |
| Como rastrear diferentes tipos de links? | É possível rastrear automaticamente os downloads de arquivo e links de saída com base nos parâmetros definidos no arquivo AppMeasurement para JavaScript. [Mais em...](https://docs.adobe.com/content/help/pt-BR/analytics/implementation/javascript-implementation/function-tl.html) |
| Como rastrear vídeos? | O JavaScript pode ser utilizado para rastrear vários reprodutores. Para rastrear com o JavaScript, basta adicionar o código à página da Web que contém o reprodutor o rastreá-lo utilizando manipuladores de evento. [Mais em...](https://docs.adobe.com/content/help/pt-BR/media-analytics/using/media-overview.html) |
...
| Como implementar o rastreamento de vídeo? | É possível rastrear reprodutores de mídia ao criar funções vinculadas aos manipuladores de evento do reprodutor de vídeo. Isso permite chamar Media.open, Media.play, Media.stop e Media.close no momento certo. [Mais em...](https://docs.adobe.com/content/help/pt-BR/media-analytics/using/media-overview.html) |
| Como configurar o cookie primário? | O Analytics usa cookies para fornecer informações sobre variáveis e componentes que não persistem entre as solicitações de imagem e as sessões do navegador. Esses cookies inofensivos são originários de um domínio hospedado pela Adobe, conhecidos como cookies de terceiros. [Mais em...](https://marketing.adobe.com/resources/help/en_US/whitepapers/first_party_cookies/fpcookies_cert.html) |
| Como posso obter um certificado SSL? | Determine se seu site usa o protocolo `https://`. Se o fizer, é necessário solicitar um CSR e comprar um certificado SSL. Observação: não é necessário um certificado SSL se você não tem páginas ou conteúdos seguros. Esta etapa pode ser ignorada se você só usar o protocolo `https://` no site.  [Mais em...](https://marketing.adobe.com/resources/help/en_US/whitepapers/first_party_cookies/fpcookies_cert.html) |
| Onde encontro informações sobre o aviso de expiração da certificação? | Os certificados SSL expiram anualmente, o que significa que a Adobe exige uma solicitação de certificado atualizada sempre que isso acontece. O especialista FPC fornece os avisos necessários quando isso ocorre, no entanto, recomenda-se ser proativo no monitoramento da validade e no fornecimento à Adobe deste certificado atualizado. [Mais em...](https://marketing.adobe.com/resources/help/en_US/whitepapers/first_party_cookies/adobe_managed_cert_pgm.html) |
...
| Como encontrar informações sobre a API de inserção de dados? | A Adobe criou várias maneiras de enviar dados para o Analytics. [Mais em...](https://helpx.adobe.com/br/analytics/kb/data-insertion-api-post-method-adobe-analytics.html) |
| O que é um erro 500? | As informações sobre o erro do servidor interno que causou um status "Erro de consulta 500" podem ser encontradas na [variável pageType](https://docs.adobe.com/content/help/pt-BR/analytics/implementation/javascript-implementation/variables-analytics-reporting/page-variables.html#concept_F67870238EF74491B5D3909A33CDB985). |