...
description: Os analisadores de pacote permitem que você visualize os dados enviados por sua implementação para os servidores de coleta de dados da Adobe.
...
Os analisadores de pacote permitem que você visualize os dados enviados por sua implementação para os servidores de coleta de dados da Adobe.

Semelhante ao depurador da Adobe Experience Cloud, um monitor de pacote mostra quais parâmetros de dados estão sendo transmitidos em uma solicitação de imagem; entretanto, os monitores de pacote fornecem funcionalidade adicional:
