...
| **3<sup>rd</sup>** | `mid` | Para implementações baseadas em AppMeasurement (incluindo a extensão de tag do Analytics) usando o [Serviço de ID de Visitante](https://experienceleague.adobe.com/pt-br/docs/id-service/using/home), o visitante tem um cookie [`s_ecid`](https://experienceleague.adobe.com/en/docs/core-services/interface/data-collection/cookies/analytics) ou `AMCV` existente. Para implementações baseadas no Web SDK, o visitante tem um cookie [`kndctr_<orgId>_identity`](https://experienceleague.adobe.com/en/docs/core-services/interface/data-collection/cookies/web-sdk) ou `AMCV` existente. A Adobe recomenda usar a ECID como a forma principal de identificação do visitante para todas as implementações, quando possível. |
