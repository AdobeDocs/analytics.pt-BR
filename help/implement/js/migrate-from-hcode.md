...
1. **Atualizar todos os plug-ins**: certifique-se de usar a versão mais recente de cada plug-in listado no arquivo `s_code.js`. Esta etapa inclui os módulos Mídia e Integração.
