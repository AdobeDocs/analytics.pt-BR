...
* **Canal:** pode se referir a:
   * A variável Canal, que preenche a dimensão Seções do site. See [Page variables](/help/implement/vars/page-vars/page-variables.md) in the Implement user guide.
