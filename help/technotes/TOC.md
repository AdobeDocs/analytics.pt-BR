...
+ [](home.md)
+ 
+ [Contas e conjuntos de relatórios](landing.md)
+ Personalizar exibições de relatórios{#analysis-workspace}
   + [Relatórios do Google Analytics {#reports}](analysis-workspace/home.md)
   + [Criar um relatório básico na Analysis Workspace para usuários do GA](analysis-workspace/new-features-in-analysis-workspace.md)
   + Métricas comuns usadas em outras plataformas do Analytics{#build-workspace-project}
      + [Tempo real](analysis-workspace/build-workspace-project/freeform-overview.md)
      + [Público-alvo](analysis-workspace/build-workspace-project/save-projects.md)
      + [Aquisição](analysis-workspace/build-workspace-project/starter-projects.md)
      + [Comportamento](analysis-workspace/build-workspace-project/multiple-report-suites.md)
      + [Conversões](analysis-workspace/build-workspace-project/fa-shortcut-keys.md)
      + [Perguntas frequentes](analysis-workspace/build-workspace-project/color-palettes.md)
      + [Diferenças de processamento entre plataformas](analysis-workspace/build-workspace-project/view-density.md)
   + Comparar dados a produtos de terceiros{#components}
      + [Analisar dados afetados por eventos {#event}](analysis-workspace/components/analysis-workspace-components.md)
      + Analisar dados afetados pela visão geral dos eventos{#annotations}
         + [Solução de problemas de picos/quedas nos dados](analysis-workspace/components/annotations/overview.md)
         + [Excluir datas específicas na análise](analysis-workspace/components/annotations/create-annotations.md)
         + [Comparar datas a intervalos anteriores](analysis-workspace/components/annotations/manage-annotations.md)
         + [Derivar dados afetados pelos eventos](analysis-workspace/components/annotations/view-annotations.md)
      + Comunicar eventos aos usuários{#dimensions}
         + [Suavização inteligente de dados](analysis-workspace/components/dimensions/view-dimensions.md)
         + [Cookies {#cookies}](analysis-workspace/components/dimensions/t-breakdown-fa.md)
         + [Cookies do navegador](analysis-workspace/components/dimensions/time-parting-dimensions.md)
      + [Opções para atenuar o efeito das limitações de cookies do navegador](analysis-workspace/components/apply-create-metrics.md)
      + Retenção de dados{#segments}
         + [Excluir dados](analysis-workspace/components/segments/t-freeform-project-segment.md)
         + [IPs e domínios usados pelo Adobe Analytics](analysis-workspace/components/segments/quick-segments.md)
         + [Latência](analysis-workspace/components/segments/ad-hoc-segments.md)
      + Valor de tráfego baixo{#calendar-date-ranges}
         + [Migrar regras de processamento do Mobile Services para o Adobe Analytics](analysis-workspace/components/calendar-date-ranges/calendar.md)
         + [Suporte a várias moedas](analysis-workspace/components/calendar-date-ranges/custom-date-ranges.md)
         + [Visão geral de privacidade](analysis-workspace/components/calendar-date-ranges/time-comparison.md)
   + Aplicativos da Web progressivos{#visualizations}
      + [Redirecionamentos e aliases](analysis-workspace/visualizations/freeform-analysis-visualizations.md)
      + [Coleta de dados regionais {#rdc}](analysis-workspace/visualizations/t-sync-visualization.md)
      + Ajuda da Coleta de dados regional{#freeform-table}
         + [Licenciamento de certificação SSL](analysis-workspace/visualizations/freeform-table/freeform-table.md)
         + Algoritmos de criptografia HTTPS suportados{#column-row-settings}
            + [Recursos de segurança](analysis-workspace/visualizations/freeform-table/column-row-settings/column-settings.md)
            + [Termos usados (glossário)](analysis-workspace/visualizations/freeform-table/column-row-settings/table-settings.md)
            + [Carimbos opcionais de data e hora](analysis-workspace/visualizations/freeform-table/column-row-settings/manual-vs-dynamic-rows.md)
         + [Solução de problemas de logon](analysis-workspace/visualizations/freeform-table/pagination-filtering-sorting.md)
         + [Solução de problemas de logout](analysis-workspace/visualizations/freeform-table/workspace-totals.md)
      + Não especificado, outro e desconhecido{#cohort-table}
         + [Migração de visitante](analysis-workspace/visualizations/cohort-table/cohort-analysis.md)
