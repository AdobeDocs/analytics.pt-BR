...
2. No menu esquerdo, clique em *[!UICONTROL Site Metrics]* > *[!UICONTROL Real-Time]*.
3. Se o conjunto de relatórios ainda não tiver o tempo real ativado, uma mensagem será exibida com um link para configurar o conjunto de relatórios. If the report suite has real-time enabled, click [!UICONTROL Configure] near the real-time report&#39;s title.
...
3. Clique em [!UICONTROL Save and View Report].
