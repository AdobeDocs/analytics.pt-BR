---
description: A nova página de aterrissagem do Adobe Analytics reúne o Analysis Workspace e o Reports & Analytics em uma única interface e ponto de acesso no Workspace.
...
A nova página de aterrissagem do Adobe Analytics reúne o Analysis Workspace e o Reports &amp; Analytics em uma única interface e ponto de acesso no Workspace. Ela apresenta uma nova página inicial do gerente de projeto, um menu de relatórios atualizado com relatórios modernizados, bem como uma nova seção de aprendizado que ajuda você a começar de forma mais eficaz.
...
* Principais alterações no menu do Analytics: o menu superior de **[!UICONTROL Relatórios]** não está mais presente. A maioria dos relatórios agora está no menu [!UICONTROL Relatórios] no painel esquerdo.
* O painel esquerdo tem três guias: [!UICONTROL Projetos], [!UICONTROL Relatórios] e [!UICONTROL Aprendizagem]. Abordamos cada uma delas com mais detalhes nas seções seguintes.
...
| Ícone Fixar | **Novo** Agora é possível fixar itens e eles *sempre* aparecem no topo da lista. |
...
| Os administradores podem designar essa nova página de aterrissagem para os usuários? | Não, os administradores não podem designar a nova página de aterrissagem em nome dos usuários. Os usuários individuais devem ativar a alternância. |
