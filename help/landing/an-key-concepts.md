...
| Análise de big data (antigo Insight) | Desenvolvido para coletar, processar, analisar e visualizar dados de interações online e offline do cliente em vários canais. | [Cliente do Data Workbench](https://marketing.adobe.com/resources/help/en_US/insight/client/) |
...
| Adobe Launch | A a próxima geração de recursos de Gerenciamento de tags de site e de SDKs móveis da Adobe. | [Página inicial do Adobe Launch](https://docs.adobe.com/content/help/pt-BR/launch/using/overview.html) |
...
| VISTA | Permite aplicar a lógica do lado do servidor para alterar ou segmentar dados conforme são coletados. | [Regras VISTA](https://marketing.adobe.com/resources/help/en_US/reference/VISTA.html) |
...
| Opções de depuração | Há vários depuradores e sniffers de pacotes disponíveis para ajudar a validar sua implementação, incluindo o Adobe Experience Cloud Debugger. | [Adobe Debugger](https://chrome.google.com/webstore/detail/adobe-experience-cloud-de/ocdmogmohccmeicdhlhhgepeaijenapj?hl=pt) |
