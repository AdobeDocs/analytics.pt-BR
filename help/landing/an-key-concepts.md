...
| --- | --- | --- |
| Analysis Workspace | Solução de navegador para desenvolver projetos de análise avançados e personalizados, bem como para democratizar informações. Ofertas mais flexibilidade de relatório do que a Reports and Analytics | [Analysis Workspace home](/help/analyze/analysis-workspace/home.md) |
| Relatórios e análises do  (antigo SiteCatalyst) | Solução de navegador para relatórios e análises. Ferramenta inicial no pacote do Analytics. | [Reports and Analytics home](/help/analyze/reports-analytics/getting-started.md) |
...
| Ad Hoc Analysis (antigo Discover) | Ferramenta baseada em Java para análise digital avançada. | [Página inicial da Ad Hoc Analysis](/help/analyze/ad-hoc-analysis/adhoc-home.md) |
...
| Data Connectors do Adobe Exchange (antigo Genesis) | Importe dados de rastreamento de aplicativos de terceiros para o Analytics, oferecendo visibilidade completa ao desempenho em um local central. | [Página inicial dos Data Connectors](/help/import/data-connectors/data-connectors-eol.md) |
| Dynamic Tag Management (DTM) | Ajuda a gerenciar suas tags do Analytics, do Target e de outras soluções em todos os seus sites, independentemente do número de domínios. | [Página inicial do DTM](/help/implement/other/dtm/dtm-implementation-overview.md) |
...
| Opções de depuração | Há vários depuradores e sniffers de pacote disponíveis para ajudar a validar sua implementação, incluindo o depurador do Adobe Experience Cloud. | [Adobe Debugger](https://chrome.google.com/webstore/detail/adobe-experience-cloud-de/ocdmogmohccmeicdhlhhgepeaijenapj?hl=pt) |
