...
+ Analysis Workspace {#analysis-workspace}
   ...
   + Componentes {#components}
      ...
      + Calendário e intervalos de datas {#calendar-date-ranges}
         ...
         + [Comparar datas afetadas por um evento](analysis-workspace/components/calendar-date-ranges/compare-event.md)
   ...
   + Painéis {#panels}
      ...
      + [Criador de insights rápidos](analysis-workspace/c-panels/quickinsight.md)
...
+ dashboards {#mobapp}
   + [Visão geral dos painéis](mobile-app/home.md)
