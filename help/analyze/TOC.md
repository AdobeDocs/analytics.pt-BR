...
+ Analysis Workspace {#analysis-workspace}
   ...
   + Build a Workspace project {#build-workspace-project}
      ...
      + Column and row settings {#column-row-settings}
         ...
         + [Linhas manuais vs. dinâmicas](analysis-workspace/build-workspace-project/column-row-settings/manual-vs-dynamic-rows.md)
      + [Desfazer e refazer configurações](analysis-workspace/build-workspace-project/undo-redo.md)
   ...
   + Componentes {#components}
      ...
      + Calendar and date ranges {#calendar-date-ranges}
         + [Visão geral de calendário e intervalos de data](analysis-workspace/components/calendar-date-ranges/calendar.md)
   ...
   + Visualizações {#visualizations}
      ...
      + Tabela de coorte{#cohort-table}
         + [O que é uma análise de coorte?](analysis-workspace/visualizations/cohort-table/cohort-analysis.md)
      ...
      + [Gráfico de marcador](analysis-workspace/visualizations/bullet-graph.md)
   ...
   + Painéis {#panels}
      ...
      + Segment comparison (IQ) {#segment-comparison}
         ...
         + [Testes estatísticos usados na comparação de segmentos](analysis-workspace/c-panels/c-segment-comparison/statistical-test.md)
   + Curate or Share projects {#curate-share}
      ...
      + [Enviar arquivo - agendar um projeto para entrega](analysis-workspace/curate-share/t-schedule-report.md)
      + [Gerenciador de projetos agendados](analysis-workspace/curate-share/schedule-projects.md)
   + Attribution IQ {#attribution-iq}
      + [Visão geral IQ da atribuição](analysis-workspace/attribution-iq/attribution.md)
      + [Usar IQ de atribuição na Analysis Workspace](analysis-workspace/attribution-iq/use-attribution-iq.md)
      + [Usar atribuição em Métricas calculadas](analysis-workspace/attribution-iq/attribution-calcmetrics.md)
      + [Perguntas frequentes sobre o Attribution IQ](analysis-workspace/attribution-iq/attribution-faq.md)
   ...
   + [Perguntas frequentes](analysis-workspace/faq.md)
   + [Requisitos de administração](analysis-workspace/frequently-asked-questions-analysis-workspace.md)
   + [Otimizar o desempenho da Workspace](analysis-workspace/optimizing-performance.md)
...
+ Report Builder {#report-builder}
   ...
   + [Novidades do Construtor de relatórios](report-builder/whats-new-arb.md)
   + Report Builder setup {#report-builder-setup}
      ...
      + [Invocar a funcionalidade do Construtor de relatórios a partir das funções do Microsoft Excel](report-builder/setup/invoke-arb-excel-function.md)
   + [Barra de ferramentas do Construtor de relatórios](report-builder/reportbuilder-toolbar.md)
   + Data requests {#data-requests}
      + [Solicitações de dados - Etapa 1 do Assistente de solicitações](report-builder/data-requests/data-requests.md)
      ...
      + Report suites {#report-suites}
         ...
         + [Selecionar um conjunto de relatórios de uma solicitação existente no Excel](report-builder/data-requests/selecting-report-suites/t-select-a-report-suite-from-an-existing-request-in-excel.md)
      ...
      + [Permitir substituições da lista de publicação](report-builder/data-requests/allow-publishing-list-overrides.md)
      + Report types {#report-types}
         + [Visão geral dos tipos de relatório](report-builder/data-requests/c-report-types/select-report-types.md)
         ...
         + [Filtrar um relatório de caminho usando o Assistente de solicitação](report-builder/data-requests/c-report-types/path-filter.md)
         + [Filtrar um relatório de fallout usando o Assistente de solicitação](report-builder/data-requests/c-report-types/fallout-filter.md)
         ...
         + [Selecione um tipo de relatório](report-builder/data-requests/c-report-types/t-select-report-type.md)
      ...
      + Intervalos de data {#date-ranges}
         ...
         + Customized date expressions {#customized-date-expressions}
            + [Expressões de data personalizadas - visão geral](report-builder/data-requests/configuring-report-dates/c-customized-date-expressions/t-customized-date-expressions.md)
            + [Abreviações de data](report-builder/data-requests/configuring-report-dates/c-customized-date-expressions/date-abbreviations.md)
   ...
   + Layout - Etapa 2 do assistente de solicitações {#layout}
      ...
      + Metrics and dimensions {#metrics-dimension}
         + [Visão geral das métricas e dimensões](report-builder/layout/c-metrics-dimensions/metrics-dimensions.md)
         ...
         + [Modificar métricas - definições de campo](report-builder/layout/c-metrics-dimensions/r-arb-modify-metrics.md)
      ...
      + [Incluir texto em células como prefixo e sufixo](report-builder/layout/prepend-and-postpend-text-to-cells.md)
   ...
   + Manage requests {#manage-requests}
      ...
      + [Atualizar solicitações de todas as planilhas](report-builder/manage-requests/t-refresh-requests-for-all-sheets.md)
      ...
      + Copy requests {#copy-requests}
         + [Visão geral das solicitações copiar](report-builder/manage-requests/c-copy-requests/copy-requests.md)
   ...
   + Biblioteca de pastas de trabalho {#workbook-library}
      ...
      + [Programar pastas de trabalho com macros habilitadas](report-builder/workbook-library/schedule-macro-wb.md)
   + Publish to Power BI with Report Builder 5.5 {#publish-powerbi}
      ...
      + [Importar dados manualmente para o Power BI](report-builder/c-publish-power-bi/bi-manually-import-data.md)
      + [Puxar ativos publicados para o Power BI Desktop](report-builder/c-publish-power-bi/bi-publish-to-desktop.md)
   ...
   + [Solução de problemas e práticas recomendadas para o Construtor de relatórios](report-builder/troubleshoot.md)
+ Mapa de atividade {#activity-map}
   + [Visão geral do Activity Map](activity-map/activity-map.md)
   + [Rastreamento robusto de links](activity-map/lnk-tracking-overview.md)
   ...
   + [Análise de página em tempo real (Live)](activity-map/activitymap-realtime.md)
   ...
   + Get started {#getting-started}
      + Get started for admins {#get-started-admins}
         + [Ativar Activity Map](activity-map/activitymap-getting-started/activitymap-getting-started-admins/activitymap-enable.md)
      ...
      + Get started for users {#get-started-users}
         + [Instalar plug-ins do navegador do Mapa de atividade](activity-map/activitymap-getting-started/activitymap-getting-started-users/activitymap-install.md)
   ...
   + Link tracking {#link-tracking}
      + [Metodologia de rastreamento de link](activity-map/activitymap-link-tracking/activitymap-link-tracking-methodology.md)
      + [Perguntas frequentes sobre o rastreamento de link](activity-map/activitymap-link-tracking/link-tracking-faq.md)
      ...
      + [Parar o rastreamento de links](activity-map/activitymap-link-tracking/activitymap-stop-link-tracking.md)
      + [Usar a função s. tl ()](activity-map/activitymap-link-tracking/activitymap-stl-track-custom-elements.md)
   + [Configurar configurações do Activity Map](activity-map/activitymap-overlay-settings.md)
   ...
   + [Integração com o AEM Sites e Activity Map](activity-map/aem-sites-integration.md)
   + [Solução de problemas das extensões do navegador](activity-map/troubleshooting-browser-extensions.md)
   + [Recursos de conhecimento](activity-map/activitymap-info-resources.md)
+ Reports and Analytics {#reports-analytics}
   + [Introdução ao Relatórios e análises](reports-analytics/getting-started.md)
   ...
   + [Configuração de configurações de exibição e navegação](reports-analytics/report-settings.md)
   + [Programação e distribuição do relatório](reports-analytics/scheduling.md)
   ...
   + Customize reports {#customize-reports}
      + [Personalizar visão geral dos relatórios](reports-analytics/reports-customize/customizing-reports-overview.md)
...
+ Ad Hoc Analysis {#ad-hoc-analysis}
   + Conversor de projeto da Ad Hoc Analysis {#aha-project-converter}
      + [Visão geral do projeto da Análise ad hoc](ad-hoc-analysis/c-aha-project-converter/aha2aw-overview.md)
      + [Converter projetos na Análise ad hoc](ad-hoc-analysis/c-aha-project-converter/aha2aw-workflow.md)
      + [Exibir projetos convertidos na Analysis Workspace](ad-hoc-analysis/c-aha-project-converter/view-projects-workspace.md)
      + [Perguntas frequentes do Conversor de projetos](ad-hoc-analysis/c-aha-project-converter/aha2aw-converter-faq.md)
   + [Visão geral da análise ad hoc](ad-hoc-analysis/adhoc-home.md)
   + [Introdução](ad-hoc-analysis/c-getting-started.md)
   + [Administração](ad-hoc-analysis/c-administration.md)
   + [Executar análise ad hoc com Java 11](ad-hoc-analysis/adhoc-java.md)
