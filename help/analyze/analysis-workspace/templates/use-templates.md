...
1. Na seção [!UICONTROL **Modelos**], selecione uma das guias a seguir:
   ...
   * Modelos da **[!UICONTROL _login _company_name_]**: mostra todos os modelos da empresa que foram criados para a sua organização.

     Somente administradores podem criar modelos da empresa. Para obter mais informações sobre como criar um modelo de empresa, consulte [Criar e gerenciar modelos](/help/analyze/analysis-workspace/templates/create-templates.md).
...
1. No campo de pesquisa, comece a digitar o nome do modelo que deseja localizar e, em seguida, selecione-o na lista de modelos. Também é possível pesquisar a lista de modelos por propriedade, eVar e número do evento. <!-- still true? -->
...
Um modelo pode não suprir exatamente as suas necessidades, mas pode chegar perto. Nesses casos, é possível usar o modelo como ponto de partida e personalizá-lo para atender melhor às suas finalidades específicas.
...
1. (Opcional) Salve o modelo como um projeto, selecionando [!UICONTROL **Projeto**] > [!UICONTROL **Salvar**].
   ...
   O modelo é salvo como um novo projeto e não modifica o modelo existente. Para mais informações sobre como salvar projetos, consulte [Salvar projetos](/help/analyze/analysis-workspace/build-workspace-project/save-projects.md).
...
>abstract="**Isso pode ajudar você** a entender melhor a geração de valor do Adobe Experience Manager.<br/>**Com base no que aprender, você poderá** realizar várias ações, como otimizar as configurações do Experience Manager."
...
>title="Veja dados de desempenho do Adobe Experience Manager Forms."
>abstract="**Isso pode ajudar você** a entender melhor a geração de valor do Adobe Experience Manager.<br/>**Com base no que aprender, você poderá** realizar várias ações, como otimizar as configurações do Experience Manager."
...
>abstract="**Isso pode ajudar você** a entender melhor a potencial perda de dados devido às restrições de cookies impostas pela ITP.<br/>**Com base no que aprender, você poderá** realizar várias ações, como adaptar a configuração de análise para minimizar o impacto da ITP."
...
>abstract="**Isso pode ajudar** a entender melhor o que as pessoas acessam ao entrar pela primeira vez no site, quais seções do site são mais visitadas e quais páginas tendem a afastar as pessoas do site.<br/>**Com base no que aprender, você poderá** fazer várias coisas, como avaliar quais caminhos no site direcionam as pessoas às páginas mais importantes e quais páginas têm a maior probabilidade de afastá-las do site.<br/>Este modelo usa a dimensão “Página” e as métricas “Exibições da página”, “Visitas”, “Visitantes únicos”, “Taxa de entrada”, “Taxa de rejeição”, “Taxa de saída” e “Velocidade do conteúdo”. Ele também usa visualizações de fluxo para as seções de entrada, de saída e superior; uma visualização de gráfico de dispersão, que mostra as exibições das páginas mais comuns; uma visualização de barras, que mostra as exibições da página por tempo classificado; e uma visualização de linhas, que mostra uma exibição de tendências do tempo médio dedicado ao site."
...
| [!UICONTROL **Tempo real**] | Visualize as dimensões e métricas que estão sendo coletadas no site. <p>**Isso pode ajudar** a entender melhor as tendências do site.</p><p>**Com base no que aprender, você poderá** gerenciar ativamente e responder ao desempenho do conteúdo de marketing e das campanhas atuais.</p> <p>Este modelo usa o [Relatório em tempo real](/help/admin/tools/manage-rs/edit-settings/realtime/realtime.md).</p> |
...
| **[!UICONTROL Entradas e saídas]** > [!UICONTROL **Visitas de página única**] | Visualize o número de visitas que consistiram em uma única página. <p>**Isso pode ajudar** a entender melhor os níveis de engajamento dos visitantes e quanto tempo estão gastando no site.</p><p>**Com base no que aprender, você poderá** fazer várias coisas, como avaliar se as alterações no site resultam em visitantes permanecendo por mais tempo.</p><p>Este modelo usa a [dimensão Visitas de página única](/help/components/dimensions/single-page-visits.md).</p> |
| **[!UICONTROL Entradas e saídas]** > [!UICONTROL **Páginas de saída**] | Confira as principais páginas que as pessoas acessam imediatamente antes de sair do site.<p>**Isso pode ajudar** a entender melhor quais páginas estão afastando as pessoas do site. </p><p>**Com base no que aprender, você poderá** fazer várias coisas, como atualizar as páginas de saída comuns para otimizar a experiência que as pessoas têm antes de sair ou incluir conteúdo e links para incentivá-las a permanecerem no site.</p><p>Este modelo usa a métrica “Sessões”. Ele também usa a visualização de barras e a visualização de tabela de forma livre.</p> |
...
| **Perfil do visitante** > **Tecnologia** > **Altura do navegador** | Veja as principais alturas dos navegadores que as pessoas usam para acessar o site.<p>**Isso pode ajudar** a entender melhor como o conteúdo é exibido para os visitantes.</p><p>**Com base no que aprender, você poderá** fazer várias coisas, como melhorar a qualidade do site ao testar novas versões dele usando as alturas de navegador mais comuns. Isso pode maximizar ações de controle de qualidade.</p><p>Este modelo usa a dimensão Navegador. </p> |
...
| **Dispositivos móveis** > **Desempenho do aplicativo móvel** | Visualize o desempenho do aplicativo e onde os usuários estão com problemas. <p>**Isso pode ajudar** a entender se as pessoas que usam o aplicativo estão encontrando lentidão ou desempenho degradado. </p><p>**Com base no que aprender, poderá** fazer várias coisas, como corrigir problemas existentes ou melhorar o desempenho do aplicativo antes que eles ocorram.</p><!-- This template uses the --> |
...
| **Classificação de todas as páginas de pesquisa** | Veja em qual página dos resultados da pesquisa um(a) visitante clicou para acessar o site. Por exemplo, se o site for exibido na segunda página dos resultados de um mecanismo de pesquisa, o item de dimensão dessa variável será “Página de pesquisa 2”.<p>**Isso pode ajudar** a entender melhor a classificação das suas páginas em resultados de pesquisa.</p><p>**Com base no que aprender, você poderá** fazer várias coisas, como melhorar a estratégia de SEO para garantir que o seu conteúdo apareça na primeira página dos resultados de pesquisa. </p> |
