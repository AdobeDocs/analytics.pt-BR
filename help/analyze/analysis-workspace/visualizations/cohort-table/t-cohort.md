...
1. (Opcional) Ajuste a variável **[!UICONTROL Configurações da tabela de coorte]** clicando no ícone de engrenagem.
...
Como outras visualizações no Analysis Workspace, é possível baixar uma visualização de coorte como um arquivo CSV ou PDF. Para obter mais informações, consulte [Baixar arquivos PDF ou CSV](/help/analyze/analysis-workspace/curate-share/download-send.md).
