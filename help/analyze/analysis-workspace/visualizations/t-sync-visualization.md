...
1. Na visualização, clique no ponto ao lado do título para abrir a caixa de diálogo **[!UICONTROL Data Source]**. Selecione **[!UICONTROL Show Data Source]** ou **[!UICONTROL Lock Selection]**.
