...
A visualização ![DispersãoGráfico](/help/assets/icons/GraphScatter.svg) **[!UICONTROL Dispersão]** ajuda a identificar correlações e padrões entre métricas diferentes em seus dados. A visualização mostra a relação entre itens de dimensão e até três métricas. A visualização requer três componentes e permite a visualização de até quatro componentes.
