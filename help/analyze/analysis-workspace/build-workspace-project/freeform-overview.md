...
| [Exibir tutoriais](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/analysis-workspace-basics/analysis-workspace-introduction.html) | Direciona você para os tutoriais em vídeo do Analysis Workspace. |
...
| Tipo | Indica se é um projeto do Workspace ou um [Scorecard móvel](https://experienceleague.adobe.com/docs/analytics/analyze/mobapp/home.html). |
