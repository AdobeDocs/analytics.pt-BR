...
# Usar relatórios pré-criados

Os relatórios pré-criados na Analysis Workspace fornecem insights rápidos sobre os cenários de relatórios mais comuns. A seguir estão alguns exemplos de perguntas que você pode responder com relatórios pré-criados:
...
As informações a seguir descrevem como acessar e usar relatórios pré-criados da [!UICONTROL Relatórios] no Analysis Workspace.

## Acessar e executar um relatório

1. No Analysis Workspace, selecione a variável [!UICONTROL **Workspace**] guia.

1. Selecionar [!UICONTROL **Relatórios**].
...
1. No campo de pesquisa, comece digitando o nome do relatório que deseja localizar, em seguida, selecione-o na lista de relatórios. Também é possível pesquisar a lista de relatórios por propriedade, eVar e número do evento. <!-- still true? -->
   ...
   Selecione a categoria de relatório que deseja exibir e selecione o relatório na lista de relatórios.

   >[!TIP]
   >
   >   Para navegar no menu usando as teclas de seta, pressione a tecla de barra (/) e, em seguida, pressione a tecla de seta para baixo. Pressione Enter para carregar o relatório selecionado.

Para obter uma lista de relatórios disponíveis, consulte [Relatórios disponíveis](#available-reports) abaixo.
...
1. (Opcional) Salve o relatório como um projeto selecionando [!UICONTROL **Projeto**] > [!UICONTROL **Salvar**].
   ...
   O relatório é salvo como um novo projeto; ele não modifica o relatório existente. Para obter mais informações sobre como salvar um relatório como um projeto, consulte [Salvar projetos](/help/analyze/analysis-workspace/build-workspace-project/save-projects.md).
