...
| Gerenciador de configurações e fonte combinados para visualizações | 14 de janeiro de 2021 | O gerenciador de [!UICONTROL Fonte de dados] (ponto) e o gerenciador de configurações (engrenagem) para visualizações foram combinados em um único pop-over para que você possa gerenciar facilmente a fonte e as configurações no mesmo local. |

## Outubro de 2020

| Recurso | Descrição |
| --- | --- |
| Visualização de linha: [opção de linha de tendências da média móvel](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/visualizations/line.html?lang=pt-BR) | **[!UICONTROL A média móvel]** foi adicionada às configurações de linha de tendência da visualização de [!UICONTROL Linha]. Também conhecida como média variável, uma média móvel usa um número específico de pontos de dados (determinado por uma seleção de **[!UICONTROL Períodos]**), faz a média deles e usa a média como um ponto na linha. |
| [Página de ajuda de desempenho](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/workspace-faq/optimizing-performance.html?lang=pt-BR) | A página de ajuda de desempenho do Analysis Workspace mostra os diferentes fatores que afetam o desempenho do projeto e oferece links com dicas de otimização. |
...
Novos recursos lançados em 18 de junho de 2020.
...
Novos recursos lançados em 21 de maio de 2020.
...
Melhorias lançadas em 10 de outubro de 2019.
...
| Aprimoramento | Descrição |
|--- |--- |
| Melhorias na análise de coorte | Novas [configurações de Análise de coorte](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/visualizations/cohort-table/t-cohort.html?lang=pt-BR) foram adicionadas: <ul><li>Mostrar somente a porcentagem</li><li>Arredondar porcentagem ao inteiro mais próximo</li><li>Mostrar uma linha de porcentagem média</li></ul> |
...
| Novo modelo do Analysis Workspace | Adicionamos um novo modelo chamado [“Magento: Marketing &amp; Commerce”](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/build-workspace-project/starter-projects.html?lang=pt-BR) ao Analysis Workspace. Ele foi projetado especificamente para clientes de comércio eletrônico do Magento, mas qualquer varejista pode usá-lo para obter informações exclusivas sobre suas atividades de comércio. |
...
| [Compatível com variáveis de vários valores no Attribution](/help/analyze/analysis-workspace/attribution/overview.md) | Algumas dimensões no Analytics podem conter vários valores em uma única ocorrência, como listVars, a variável do produto, propriedades de lista ou eVars de merchandising. O Analysis Workspace permite aplicar o Attribution a qualquer um desses tipos de variáveis no nível de ocorrência. |
...
<table id="table_137719BFA03C44A78FDE872DF8B228A4">
 ...
 <tbody>
  ...
  <tr>
   ...
   <td colname="col2"> <p>Consulte <a href="https://experienceleague.adobe.com/docs/media-analytics/using/media-reports/media-workspace-templates.html?lang=pt-BR"  >Análise de áudio</a>. </p> </td>
  </tr>
 </tbody>
</table>
...
<table id="table_EE4C690A178B4F80BDAF2BB4424D6020">
 ...
 <tbody>
  ...
  <tr>
   <td colname="col1"> <p><b>Informações adicionais sobre <a href="/help/analyze/analysis-workspace/c-anomaly-detection/view-anomalies.md"  > anomalias </a></b> </p> </td>
...
<table id="table_B9E784CD14A1453EB360FCCDC612250F">
 ...
 <tbody>
  ...
  <tr>
   <td colname="col1"> <p> <a href="/help/analyze/analysis-workspace/c-anomaly-detection/anomaly-detection.md"  > A Detecção de anomalias e a Análise de contribuição </a> agora estão disponíveis no Analysis Workspace </p> </td>
...
<table id="table_7A2E678577F94BDABB1276C826E6554F">
 ...
 <tbody>
  <tr>
   <td colname="col1"> <p>Mais <a href="/help/analyze/analysis-workspace/visualizations/freeform-table/filter-and-sort.md"  > opções de filtragem </a> de itens de dimensão em tabelas de forma livre </p> </td>
...
<table id="table_892279F2B4AF4DB38C64AA9AFC5657A7">
 ...
 <tbody>
  ...
  <tr>
   <td colname="col1"> <p> <a href="/help/analyze/analysis-workspace/c-anomaly-detection/view-anomalies.md"  > Opção para permitir que um intervalo de confiança redimensione um gráfico </a> </p> </td>
  ...
  <tr>
   ...
   <td colname="col2"> <p>Em vez de excluir manualmente cada elemento, agora você pode apagar todos os elementos nas seguintes áreas do Workspace: </p>
    <ul id="ul_73E06D64CDCA4E83B9FEC2FD99D41CD3">
     <li id="li_A51EF8FADFA04CC19FD79C1675597659"> <a href="/help/analyze/analysis-workspace/c-anomaly-detection/run-contribution-analysis.md"  > Componentes excluídos da Análise de contribuição </a> </li>
...
<table id="table_64E3A9960F314E2F9FFC738696EACDF7">
 ...
 <tbody>
  ...
  <tr>
   <td colname="col1"> <p><b> <a href="/help/analyze/analysis-workspace/c-anomaly-detection/run-contribution-analysis.md"  > Capacidade para destacar uma anomalia específica </a></b> </p> </td>
...
<table id="table_56258080C60F480AA83E1D5DE7D2C782">
 ...
 <tbody>
  ...
  <tr>
   <td colname="col1"> <b> <a href="/help/analyze/analysis-workspace/c-anomaly-detection/anomaly-detection.md"  > Detecção de anomalias e Análise de contribuição </a></b> </td>
...
>[!NOTE]
>
>O compartilhamento de links de relatório não está disponível se sua empresa usa logon único (tanto o logon único herdado quanto o logon pela Experience Cloud).
...
>[!NOTE]
>
>As tabelas associadas a gráficos de dispersão devem ter pelo menos duas colunas. A primeira coluna define o eixo X e a segunda coluna define o eixo Y. Se houver uma terceira coluna disponível, o Gráfico de dispersão a usa para determinar o raio do ponto. Em outras palavras, as colunas *1*, *2* e *3* mapeiam para *X*, *Y* e *raio do ponto*.
...
A área **[!UICONTROL Soltar um segmento aqui]** foi adicionada para que você possa arrastar e soltar segmentos em um projeto.
...
Acesse **[!UICONTROL Administrador]** > **[!UICONTROL Todos os administradores]** > **[!UICONTROL User management]** > **[!UICONTROL Transferir]** para transferir projetos.
