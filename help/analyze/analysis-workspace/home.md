...
Depois de entender a terminologia do componente, você pode arrastar componentes para as visualizações (incluindo tabelas de forma livre) e [criar sua análise](/help/analyze/analysis-workspace/build-workspace-project/freeform-overview.md).
