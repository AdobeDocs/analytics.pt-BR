...
| Consultas simultâneas | O número de consultas que estão sendo solicitadas pela organização ao Adobe ao mesmo tempo. Cada organização tem direito a no mínimo 5 queries simultâneos. | Se um relatório estiver demorando muito, normalmente é devido ao fato de estar em uma fila com outros relatórios. Isso significa que sua organização está tentando executar muitas solicitações simultâneas em relação a um conjunto de relatórios específico. As consultas podem vir de solicitações de API, interfaces do usuário de relatórios (Analysis Workspace, Reports &amp; Analytics, Report Builder etc), projetos agendados, relatórios agendados, alertas agendados e usuários simultâneos que fazem solicitações de relatórios. | Espalhe suas solicitações e agendamentos no conjunto de relatórios de forma mais uniforme ao longo do dia. Além disso, alterne suas solicitações para horários fora do horário de pico, quando possível. Segunda-feira de manhã, terça-feira de manhã e o primeiro de cada mês são horas de pico de relatório. |
| Capacidade do data center | A quantidade de capacidade de geração de relatórios que você e outros clientes compartilham em um data center do Adobe. | Isso é afetado pelo número de consultas simultâneas feitas pela sua organização e outras organizações em seu data center. | Sua organização tem direito a uma capacidade definida e, se o sistema estiver sob uma carga leve, o Adobe irá transferir mais capacidade para você, acima e além da sua permissão. |
