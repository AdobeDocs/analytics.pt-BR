...
* Some of the settings on the [!UICONTROL Report Settings] page do not apply. A área de trabalho da Análise usa apenas as [!UICONTROL Language/Currency/Encoding] configurações na parte inferior: [!UICONTROL Thousands separator], [!UICONTROL Scheduled Report Encoding]e [!UICONTROL CSV Separator Character].

## Attribution IQ

* A subset of metrics is not supported in [!UICONTROL Attribution IQ]. Para obter uma lista completa, consulte as Perguntas frequentes sobre [Attribution IQ](/help/analyze/analysis-workspace/c-panels/attribution/attribution-faq.md).
