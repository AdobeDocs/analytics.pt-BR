...
* Selecionar um ou mais itens de linha da tabela de forma livre, clicar com o botão direito do mouse e selecionar **[!UICONTROL Create Alert from Selection]**. Essa ação abre o Criador de alertas e preenche as métricas e os filtros automaticamente com os dados selecionados da tabela. Você pode editar o alerta, se necessário.

   ![Criar alerta a partir da seleção](assets/create-alert-from-selection.png)

* Em um relatório do Reports &amp; Analytics, vá até **[!UICONTROL More]** > **[!UICONTROL Add Alert]**. Essa ação abre o criador de alertas e preenche as métricas e os filtros automaticamente com os dados selecionados do relatório. Você pode editar o alerta, se necessário.
