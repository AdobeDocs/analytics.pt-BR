---
description: Saiba como criar e usar segmentos rápidos no Analysis Workspace.
...
Consulte ![VideoCheckedOut](/help/assets/icons/VideoCheckedOut.svg) [Quick segments](https://video.tv.adobe.com/v/345341?quality=12&learn=on&captions=por_br){target="_blank"} para ver um vídeo de demonstração.
...
>[!MORELIKETHIS]
>
>[Criar um segmento rápido](/help/components/segmentation/segmentation-workflow/seg-quick.md#create)
...
1. Select **[!UICONTROL Save]**.
   ...
   You can also [share the segment](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/curate-share/curate.html?lang=pt-BR#concept_4A9726927E7C44AFA260E2BB2721AFC6) with other people in your organization.
