...
Há várias maneiras de gerenciar componentes (individualmente ou ao selecionar mais de um). Right-click a component or click **[!UICONTROL Actions]** at the top of the component list.
