...
*Este artigo documenta o painel Quick insights no **Adobe Analytics**.<br/>Consulte o [painel do Quick Insights](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/panels/quickinsight) para a versão **Customer Journey Analytics**deste artigo.*
