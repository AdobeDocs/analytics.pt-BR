---
description: Explica como a landing page reúne a Analysis Workspace e o Reports & Analytics em uma única interface e ponto de acesso sob o guarda-chuva do Workspace.
...
A landing page do Adobe Analytics reúne a Analysis Workspace e o Reports &amp; Analytics em uma única interface e ponto de acesso sob o guarda-chuva do Workspace. Ele apresenta uma página inicial do gerente de projeto, um menu de relatórios atualizado, relatórios modernizados e uma seção de aprendizado para ajudá-lo a começar de forma mais eficaz.
...
## Acessar a landing page {#access-landing}
...
![Aterrissagem](assets/landing.png)

## Estrutura do menu

![Menu superior](assets/top-menus.png)

* Menu principal do Analytics: A maioria dos relatórios agora está no menu [!UICONTROL Relatórios] no painel esquerdo.
...
![Aterrissando tudo](assets/landing-all.png)
...
| Ícone Fixar | Você pode fixar itens e eles *sempre* aparecem na parte superior da lista. |
...
Aqui estão os menus e seus submenus. Se não conseguir encontrar um relatório específico, faça uma &quot;Pesquisa na página&quot; para encontrá-lo.
