...
Depois de fazer logon na Adobe Experience Cloud e no Analytics, ative o botão [!UICONTROL Nova página de aterrissagem — Beta] no canto inferior esquerdo. O acesso ao botão de alternância é específico do usuário por organização, não por empresa.
...
* **[!UICONTROL Os relatórios]** se referem a tudo o que foi pré-criado pela Adobe, como relatórios no Reports &amp; Analytics e modelos no Workspace. [!UICONTROL Os relatórios] também são modelos de relatório criados por sua empresa para você.
* **[!UICONTROL Os modelos]** não são mais usados como termo para projetos do Workspace pré-criados da Adobe. Agora eles estão em [!UICONTROL Relatórios].
...
| Consumo de conteúdo da Web | Envolvimento > Consumo de conteúdo da Web |
| Consumo de conteúdo de mídia | Envolvimento > Consumo de conteúdo de mídia |
| Análise entre dispositivos | Envolvimento > Análise entre dispositivos |
| Retenção na Web | Envolvimento > Retenção na Web |
| Consumo de áudio de mídia | Envolvimento > Consumo de áudio de mídia |
| Recenticidade da mídia, frequência, fidelidade | Envolvimento > Recenticidade da mídia, Frequência, Fidelidade |
| Impacto do ITP | Envolvimento > Impacto na ITP |
...
| Métrica de pessoas | Público-alvo > Métrica de pessoas |
| Visão geral da localização | Público-alvo > Perfil do visitante > Visão geral da localização |
| Visão geral da tecnologia | Público-alvo > Perfil do visitante > Tecnologia > Visão geral da tecnologia |
| Uso de aplicativos móveis | Público-alvo > Dispositivo móvel > Uso de aplicativos móveis |
| Jornadas do aplicativo móvel | Público-alvo > Dispositivo móvel > Jornadas do aplicativo móvel |
| Métricas do aplicativo móvel | Público-alvo > Dispositivo móvel > Mensagens no aplicativo móvel |
| Desempenho do aplicativo móvel | Público-alvo > Dispositivo móvel > Desempenho do aplicativo móvel |
| Retenção de aplicativos móveis | Público-alvo > Dispositivo móvel > Retenção de aplicativos móveis |
| Desempenho da campanha | Aquisição > Campanhas > Desempenho da campanha |
| Aquisição móvel | Aquisição > Aquisição móvel |
| Aquisição da Web | Aquisição > Aquisição pela Web |
...
Os relatórios personalizados são chamados de Relatórios da empresa e são encontrados no menu Relatórios da empresa (veja abaixo). Todos os criados anteriormente e os novos estão listados aqui.

Para criar um novo relatório de Empresa ,

1. Crie o Espaço de trabalho para o estado desejado.
1. Abra o menu [!UICONTROL Project] e clique em **[!UICONTROL Salvar como relatório da empresa...]**.
