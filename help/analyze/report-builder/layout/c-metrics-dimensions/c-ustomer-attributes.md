...
* Se estiver configurado como uma métrica, VisAttr será exposto como "dimensão" e métrica.
...
* O VisAttr como uma métrica suporta a "comercialização" (como Tempo gasto no site: 0 a 30, 31 a 60, ...)
