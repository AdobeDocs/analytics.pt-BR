...
O recurso Agendar também permite configurar a proteção por senha para uma pasta de trabalho e editar a programação de pastas de trabalho agendadas anteriormente.
