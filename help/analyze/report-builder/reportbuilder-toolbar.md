...
**Entrar:** Exibe o formulário [!UICONTROL Logon] para que você possa entrar com suas credenciais ou como um usuário diferente. Ele também exibe o nome da sua empresa após o logon. Consulte [Entrar Com Report Builder](/help/analyze/report-builder/setup/login.md).
