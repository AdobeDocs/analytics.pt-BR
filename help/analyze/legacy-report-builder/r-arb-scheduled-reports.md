...
| [!UICONTROL Opções de Publicação] | Esta coluna listará Power BI se uma das [opções de publicação do Power BI](https://experienceleague.adobe.com/docs/analytics/analyze/legacy-report-builder/publish-powerbi/power-bi.html) estiver selecionada. |
