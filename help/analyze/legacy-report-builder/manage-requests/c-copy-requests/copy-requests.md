...
Depois de copiar as células, o Report Builder e o Excel determinam a área necessária para colar o número mínimo de cópias. Se a área for grande o suficiente, a colagem criará uma cópia de todas as solicitações, onde cada solicitação colada terá a mesma disposição espacial e formatação das solicitações originais.
