...
**Entrar:** Exibe o formulário [!UICONTROL Logon] para que você possa entrar com suas credenciais ou como um usuário diferente. Também exibe o nome da empresa após o logon. Consulte [Logon no Report Builder](/help/analyze/legacy-report-builder/setup/login.md).
...
**Atualizar:** atualiza os dados de todas as solicitações inseridas na pasta de trabalho do Excel. Consulte [Atualizar uma solicitação](/help/analyze/legacy-report-builder/manage-requests/t-refresh-a-request.md).
