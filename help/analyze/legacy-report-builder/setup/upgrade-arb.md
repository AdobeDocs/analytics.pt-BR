...
1. Vá para o menu **[!UICONTROL Opções]** para atualizar para a versão mais recente. O número da sua versão atual é mostrado na parte inferior da caixa de diálogo Opções.
...
1. Na tela **[!UICONTROL Visão geral]**, selecione a versão de 32 bits ou de 64 bits.
