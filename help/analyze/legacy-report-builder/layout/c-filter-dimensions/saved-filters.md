...
Você salva os filtros no formulário [!UICONTROL Escolher página] ao criar um filtro. Para obter um exemplo desse procedimento, consulte [Filtros específicos](/help/analyze/legacy-report-builder/layout/c-filter-dimensions/t-specific-filters.md).
