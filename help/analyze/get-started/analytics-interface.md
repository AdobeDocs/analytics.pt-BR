...
Use o [!UICONTROL **Relatórios**] área no painel esquerdo na [!UICONTROL **Workspace**] guia. Para obter mais informações, consulte *Navegação na guia Relatórios* na [Página de destino do Adobe Analytics](/help/analyze/landing.md).
