...
2. Selecione qualquer um dos seguintes recursos do produto para configurá-lo:
   ...
   | Alertas | Alertas inteligentes permitem um controle mais detalhado dos alertas e integra a detecção de anomalias com o sistema de alertas. | [Alertas inteligentes](https://experienceleague.adobe.com/docs/analytics/components/alerts/intellligent-alerts.html) |
   ...
   | Relatórios agendados | Usuários e usuárias de nível administrativo podem ver e gerenciar relatórios agendados na organização. | [Fila de relatórios agendados](https://experienceleague.adobe.com/docs/analytics/components/scheduled-reports-admin.html) |
...
2. Selecione qualquer um dos seguintes recursos do produto para configurá-lo:
   ...
   | Conjuntos de relatórios | Permite definir as regras que controlam como os dados são processados em um conjunto de relatórios. | [Gerenciador do conjunto de relatórios](https://experienceleague.adobe.com/docs/analytics/admin/admin-tools/manage-report-suites/report-suites-admin.html) |
   ...
   | Gerenciador de código | O Gerenciador de código permite baixar o código da coleção de dados para plataformas móveis e da Web | [Gerenciador de código](https://experienceleague.adobe.com/docs/analytics/admin/admin-tools/code-manager-admin.html) |
   ...
   | Logs | Os arquivos de log ajudam a identificar quando os usuários fazem logon, suas atividades, acessos, conjuntos de relatórios e alterações de administrador. | [Logs](https://experienceleague.adobe.com/docs/analytics/admin/admin-tools/logs.html) |
   ...
   | Relatórios do Report Builder | Gerenciar a licença atribuída aos usuários do Report Builder. | [Relatórios do Report Builder](https://experienceleague.adobe.com/docs/analytics/admin/admin-tools/company-settings/report-builder-reports-admin.html) |
