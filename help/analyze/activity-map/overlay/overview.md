...
Na parte superior, é possível ver a página da Web com a barra de ferramentas inserida e as sobreposições de links. As classificações em bolha são exibidas em links para permitir a identificação do número total de cliques.
...
Na parte inferior da página, é possível ver o Relatório de links na página e o Relatório de detalhes da página, que permitem exibir um resumo das estatísticas da página da Web atual, bem como informações de fluxo da página.
