---
description: As seguintes métricas são sincronizadas como parte da integração com o appfigures.
seo-description: As seguintes métricas são sincronizadas como parte da integração com o appfigures.
...
As seguintes métricas são sincronizadas como parte da integração com o appfigures.

| Métrica | Descrição |
|---|---|
| Downloads da App Store | O número de downloads de aplicativos para dispositivos móveis. |
| Compras da App Store (no aplicativo) | O número de compras no aplicativo. |
...
| Receita da App Store (uma desligada) | A quantidade de receita associada à compra de um aplicativo. |
| Royalties da App Store (no aplicativo) | Obsoleto. |
| Royalties da App Store (um desligado) | Obsoleto. |

As seguintes dimensões de classificação reservadas são criadas pelo assistente de conectores de dados para a evar reservada do objeto appfigures.
...
| Nome da Appstore | O nome da appstore que relatou a atividade. |
| Nome do aplicativo | O nome do aplicativo móvel. |
| Nome do aplicativo | O item adquirido no aplicativo. |
...
<table id="table_504271ED1A954CCAA234738B07EDDF27"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> Classificação média da App Store (numérico) </td> 
   <td colname="col2"> <p>A classificação média do aplicativo. A métrica é calculada e definida usando a seguinte fórmula: </p> <code> [App &amp; amp; nbsp; Store &amp; amp; nbsp; Classificação] &amp; amp; nbsp; /&amp; amp; nbsp; [App &amp; amp; nbsp; Store &amp; amp; nbsp; Classificação e amp; nbsp; Divisor] </code> <p>Observação: O número de aplicativos classificados por categoria e país varia de acordo com as lojas de aplicativos. Se o aplicativo for classificado abaixo deste limite, as classificações do aplicativo não estarão disponíveis. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Avaliação geral da App Store </td> 
   <td colname="col2"> A classificação média do aplicativo. Essa métrica calculada é definida usando a seguinte fórmula: <code> [App &amp; amp; nbsp; Store &amp; amp; nbsp; classificação] e amp; nbsp; /&amp; amp; nbsp; [App &amp; amp; nbsp; Store &amp; amp; nbsp; Classificação e amp; nbsp; Divisor] </code> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_B9CF57EABE22449FBF1963E3F105E702"> 
 <tbody> 
  <tr> 
   <td> </td> 
   <td> Apis Store da App Store </td> 
   <td> Compras da App Store (no aplicativo) </td> 
   ...
   <td colname="col9"> Receita da App Store (única) </td> 
   <td colname="col10"> Classificação méd. da App Store </td> 
   <td colname="col11"> Classificações médias da App Store </td> 
  </tr> 
  <tr> 
   <td> Nome do país </td> 
  ...
  <tr> 
   <td> Classificação do nome da categoria </td> 
