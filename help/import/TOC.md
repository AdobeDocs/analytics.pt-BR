...
user-guide-description: 'Traga dados para o Adobe Analytics a partir de fontes externas, em massa ou em tempo real. '
...
+ Fontes de dados {#data-sources}
   ...
   + [Gerenciador de Fontes de dados](c-data-sources/datasrc-manager.md)
   + Modelo de Fontes de dados {#data-sources-template}
      + [Visão geral do modelo de Fontes de dados](c-data-sources/datasrc-template/datasrc-template-file.md)
   ...
   + [Fazer upload de um arquivo de Fontes de dados](c-data-sources/t-datasrc-uploading-data.md)
   ...
   + [Integração e transição de clientes](c-data-sources/datasrc-integrating-offline-data.md)
   + [ID de transição e perfis de visitante](c-data-sources/datasrc-tid-visitor-profile.md)
   + [Perguntas frequentes sobre Fontes de Dados](c-data-sources/datasrc-faq.md)
