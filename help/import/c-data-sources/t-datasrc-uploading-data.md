...
1. Depois que o arquivo .fin for carregado, é importante que você saia do site FTP das Fontes de Dados. O motivo é que o Analytics usa eventos de logout como um acionador para indicar que os arquivos estão prontos para processamento.
