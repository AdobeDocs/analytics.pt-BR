...
| Domínio e caminho de referência | A concatenação de domínio de referência e caminho de URL. São exemplos:    `www.example.com/products/id/12345` ou `ad.example.com/foo` |
