...
title: Permissões para Canais de marketing
...
# Permissões para Canais de marketing
...
| Ferramentas do Analytics | Acesso à Analysis Workspace | Concede acesso à Analysis Workspace. Os usuários devem pertencer a esse grupo (preferencial) ou ao Acesso aos Relatórios e análises para usar as dimensões dos Canais de marketing no Workspace. |
| Ferramentas do Analytics | Acesso a relatórios e análises | Concede acesso aos Relatórios e análises. Os usuários devem pertencer a esse grupo ou ao Acesso à Analysis Workspace (preferencial) para usar o Adobe Analytics. |
