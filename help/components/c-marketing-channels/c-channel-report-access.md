...
Para obter mais informações sobre perfis de produtos e permissões do Adobe Analytics no Admin Console, consulte [Perfis de produto do Adobe Analytics](/help/admin/admin-console/permissions/product-profile.md).
