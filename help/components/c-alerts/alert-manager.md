...
O gerenciador de Alertas está estruturado como o [Gerenciador de segmentos](/help/components/segmentation/segmentation-workflow/seg-manage.md) e o [Gerenciador de métricas calculadas](/help/components/c-calcmetrics/c-workflow/cm-workflow/cm-manager.md).
...
| **[!UICONTROL Ativado]** | O alerta está ativado ou desativado. |
