...
| --- | --- | --- | --- | --- |
| **[!UICONTROL Autorizado]** | Um booleano que é acionado quando o usuário é autorizado por meio da autenticação da Adobe. | Início da mídia, Fechamento da mídia | `a.media.pass.auth` | `xdm.mediaCollection.`<br>`sessionDetails.authorized`<br><br>`xdm.mediaReporting.`<br>`sessionDetails.authorized` |
