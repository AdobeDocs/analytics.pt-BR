...
>abstract="O ![conjunto de classificações](/help/assets/icons/Key.svg) *Chave* é o conjunto de classificações base e define o esquema geral, tendo precedência em qualquer conflito de mesclagem. Os outros conjuntos de classificações são aplicados em ordem de cima para baixo."
