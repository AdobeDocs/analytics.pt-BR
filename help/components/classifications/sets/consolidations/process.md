...
## Editar uma consolidação {#edit-a-classification}
...
>title="Ausente"
>abstract="A porcentagem de chaves no conjunto de classificações consolidado, mas não no conjunto de classificações de origem."
...
1. Use o relatório **[!UICONTROL Relatórios de Similaridade]** para analisar a consolidação. Este relatório mostra uma tabela com as seguintes colunas:
