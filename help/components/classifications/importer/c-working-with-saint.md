...
Os dados importados com a ferramenta de importação devem estar em um formato específico. O Adobe oferece a opção de baixar um modelo de dados com todos os detalhes do cabeçalho adequados em um arquivo de dados delimitado por tabulação. Você pode adicionar seus novos dados a esse modelo e, em seguida, importar o arquivo de dados no navegador, usando FTP.
