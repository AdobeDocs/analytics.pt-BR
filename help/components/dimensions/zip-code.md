...
A [!UICONTROL Opção código postal] em [Configurações gerais da Conta](/help/admin/tools/manage-rs/edit-settings/general/general-acct-settings-admin.md) controla como você pode preencher essa dimensão.
