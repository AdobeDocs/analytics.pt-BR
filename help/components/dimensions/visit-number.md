...
Os valores de dimensão incluem a string `"Visit number"` seguida pela representação numérica da visita na qual o visitante está no momento. Por exemplo, se o visitante nunca esteve em seu site antes, sua primeira visita pertence ao valor da dimensão `"Visit number 1"`. Se esta for a 13ª visita do visitante ao seu site, ele pertencerá ao valor da dimensão `"Visit number 13"`.
