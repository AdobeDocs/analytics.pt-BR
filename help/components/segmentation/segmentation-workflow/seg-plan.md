...
1. Considere o **público-alvo**: quem o consumirá? Com quem você compartilhará? Quais grupos de pessoas usarão esse segmento e como devo marcá-lo apropriadamente? Isso também significa fornecer uma boa descrição do segmento. No mínimo, a descrição deve responder a estas perguntas:
...
1. Decida quais **elementos** incluir na definição de segmento e quais valores. Considere a [persistência de variável](/help/components/segmentation/seg-overview.md) nesta decisão.

1. Considere como você deseja que o seu **processo de aprovação** se desenvolva. Uma única pessoa revisará e aprovará os segmentos ou será uma decisão de comitê?
