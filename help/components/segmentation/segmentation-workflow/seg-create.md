...
Você pode criar diferentes tipos de segmentos no Adobe Analytics.  O tipo selecionado depende da complexidade dos segmentos e se eles devem se aplicar somente ao projeto atual do Workspace ou se devem se aplicar a todos os projetos. Você pode criar segmentos diretamente na interface principal do Adobe Analytics ou ao trabalhar em um projeto do Workspace.

[Direitos de segmento por função](/help/components/segmentation/seg-reference/seg-rights.md) explicam quem pode criar segmentos.

Você pode criar um segmento das seguintes maneiras:

![Maneiras de criar um segmento](assets/create-segment.png)

* **A**.  Na interface principal, selecione **[!UICONTROL Componentes]** e selecione **[!UICONTROL Segmentos]**. Selecione ![AddCircle](/help/assets/icons/AddCircle.svg) [!UICONTROL **[!UICONTROL Add]**] no gerenciador [[!UICONTROL Segment]](seg-manage.md).
...
Para definir o novo segmento, use o [Construtor de segmentos](seg-build.md).

Quando você está em um projeto do Workspace, também pode criar um segmento rapidamente usando o [Segmento rápido](seg-quick.md).
