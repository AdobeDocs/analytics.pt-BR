...
Consulte [Sobre segmentos](/help/components/segmentation/seg-overview.md) para obter uma visão geral rápida. Em seguida, vá para [Configuração de um fluxo de trabalho de Segmentação](/help/components/segmentation/segmentation-workflow/seg-workflow.md) ou [Criação de segmentos](/help/components/segmentation/segmentation-workflow/seg-build.md).
