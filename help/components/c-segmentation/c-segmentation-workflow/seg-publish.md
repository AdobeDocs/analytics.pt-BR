...
Publicar um segmento na Experience Cloud permite usá-lo em atividades de marketing na [!UICONTROL Biblioteca de público-alvo], no [!DNL Target], no [!DNL Audience Manager], no [!DNL Advertising Cloud] e no [!DNL Campaign]. Atualizações recentes otimizaram significativamente o fluxo de trabalho de publicação. Anteriormente, a publicação de um segmento utilizável levava aproximadamente 48 horas.
...
* Antes de publicar segmentos, o Administrador precisa atribuir a permissão [!UICONTROL Publicação de segmentos] a um perfil de produto no [Admin Console](https://docs.adobe.com/content/help/en/core-services/interface/manage-users-and-products/admin-getting-started.html) e adicionar você ao perfil de produto.
...
1. Navegue até **[!UICONTROL Analytics &gt; Espaço de trabalho &gt; Componentes &gt; Segmentos]&gt; +**
