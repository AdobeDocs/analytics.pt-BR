...
![](assets/step1_icon.png) [ Planejar segmentos](/help/components/c-segmentation/c-segmentation-workflow/seg-plan.md)
...
![](assets/step2_icon.png) [Construir segmentos](/help/components/c-segmentation/c-segmentation-workflow/seg-build.md)

Construa e edite segmentos para uso em todos os recursos do Analytics.

Consulte [Criar os segmentos sequenciais](/help/components/c-segmentation/c-segmentation-workflow/seg-sequential-build.md) para saber como construir segmentos com o operador ENTÃO.
...
![](assets/step4_icon.png) [ Aprovar segmentos](/help/components/c-segmentation/c-segmentation-workflow/seg-approve.md)
...
![](assets/step6_icon.png) [ Compartilhar segmentos](/help/components/c-segmentation/c-segmentation-workflow/t-seg-share.md)
...
[Gerenciar segmentos](/help/components/c-segmentation/c-segmentation-workflow/seg-manage.md)
