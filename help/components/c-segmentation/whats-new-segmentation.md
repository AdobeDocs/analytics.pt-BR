...
* [Novembro de 2016](/help/components/c-segmentation/whats-new-segmentation.md)
* [Outubro de 2016](/help/components/c-segmentation/whats-new-segmentation.md)
* [Setembro de 2016](/help/components/c-segmentation/whats-new-segmentation.md)
* [Junho de 2016](/help/components/c-segmentation/whats-new-segmentation.md)
* [Janeiro de 2016](/help/components/c-segmentation/whats-new-segmentation.md)
* [Novembro de 2015](/help/components/c-segmentation/whats-new-segmentation.md)
* [Outubro de 2015](/help/components/c-segmentation/whats-new-segmentation.md)
* [Setembro de 2015](/help/components/c-segmentation/whats-new-segmentation.md)
* [Outubro de 2014](/help/components/c-segmentation/whats-new-segmentation.md)
* [Setembro de 2014](/help/components/c-segmentation/whats-new-segmentation.md)
* [Agosto de 2014](/help/components/c-segmentation/whats-new-segmentation.md)
* [Julho de 2014](/help/components/c-segmentation/whats-new-segmentation.md)
* [Maio de 2014](/help/components/c-segmentation/whats-new-segmentation.md)
...
<table id="table_57C605AE55CF415483F87676D9322EB6"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Ao criar segmentos sequenciais, agora há a opção para filtrar por tráfego “antes da sequência” ou “depois da sequência”. </p> <p> <p>Observação: esse recurso não está disponível em Ad Hoc Analysis. </p> </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_789DB70764434C7CA9D5EDD17CCC53D7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> Reports &amp; Analytics e Ad Hoc Analysis agora usam operadores consistentes e nomes de operadores ao criar segmentos. </p> <p><b>Novos operadores</b> </p> <p>Os operadores <span class="wintitle">existe</span> e <span class="wintitle">não existe</span> foram adicionados ao Reports &amp; Analytics ao segmentar com base em sequência de caracteres enumeradas. </p> <p>Os operadores <span class="wintitle">não contém todos os</span> e <span class="wintitle">não contém nenhum dos</span> foram adicionados à Ad Hoc Analysis ao segmentar com base em valores de sequências de caracteres. </p> <p><b>Operadores renomeados</b> </p> <p>Em Reports &amp; Analytics: </p> 
...
<table id="table_6FED9044F8194F299B33038831B2C12B"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p>Reports &amp; Analytics de: capacidade de criar segmentos a partir de relatórios de fallout </p> </td> 
...
<table id="table_F20DC2497F684AD7AC80ED803995B013"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p>Construção e gerenciamento de segmentos no Ad Hoc Analysis </p> </td> 
   <td colname="col2"> <p>Ad Hoc Analysis agora é parte do ambiente unificado de segmentação do Analytics que junta recursos para construir, gerenciar e compartilhar segmentos usando o Adobe Analytics. </p> <p>O painel do Construtor de segmentos no Ad Hoc Analysis recebeu novos recursos, entre eles: ícones atualizados, alterações à funcionalidade do painel e possibilidade de salvar contêiners em todos os níveis. O Gerenciador de segmentos (Organizar segmentos) recebeu novos recursos para organizar e marcar segmentos no Ad Hoc Analysis. </p> </td> 
  </tr> 
 </tbody> 
</table>
