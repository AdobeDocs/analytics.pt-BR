...
Clicar no ícone Informações ao lado do conjunto de relatórios virtual no seletor Conjunto de relatórios fornece estas informações:

* O nome do conjunto de relatórios principal.
* O nome de quaisquer segmentos aplicados a ele.
