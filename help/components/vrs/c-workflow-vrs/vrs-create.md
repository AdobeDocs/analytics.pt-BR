...
Na guia [!UICONTROL Settings], defina essas configurações e clique em **[!UICONTROL Continue]**.
...
1. Na guia [!UICONTROL Components], marque a caixa de seleção para aplicar a preparação para incluir, excluir e renomear componentes desse conjunto de relatórios virtual no Analysis Workspace.
Para obter mais informações sobre a curadoria de VRS, consulte [Curadoria de componente do conjunto de relatórios virtual](https://experienceleague.adobe.com/docs/analytics/components/virtual-report-suites/vrs-components.html?lang=en#virtual-report-suites).
