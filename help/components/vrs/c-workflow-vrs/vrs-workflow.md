...
Depois de criado, um conjunto de relatórios virtual é tratado como um conjunto de relatórios base na interface do usuário e geralmente é compatível com a maioria dos recursos estendidos. Por exemplo, os conjuntos de relatórios virtuais são exibidos nos seletores de Conjunto de relatórios e podem ser selecionados individualmente como qualquer outro conjunto de relatórios.
