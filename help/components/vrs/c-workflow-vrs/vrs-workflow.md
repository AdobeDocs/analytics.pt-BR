...
seo-description: Uma visão geral das etapas necessárias para planejar e implementar conjuntos de relatórios virtuais.
seo-title: Fluxo de trabalho do Conjunto de relatórios virtuais
solution: Analytics
