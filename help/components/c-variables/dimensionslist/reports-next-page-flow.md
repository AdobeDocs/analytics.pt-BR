...
<table id="table_A68A0DC384A74DC4895C8B01F760E175"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Clique em uma página sublinhada para expandir ainda mais o gráfico. Não há um limite para o número de páginas que podem ser incluídas no gráfico. Entretanto, é possível passar o mouse sobre uma página para ver seus dados de visita e receita. </p> <p>A Ad Hoc Analysis utiliza visualizações de páginas (ou qualquer outra métrica utilizada por você). </p> </td> 
  </tr> 
 </tbody> 
</table>
