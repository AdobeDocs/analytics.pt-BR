...
Instâncias são contados para todos os tipos de ocorrência, mas não são contados quando um valor é registrado para uma variável em uma ocorrência subsequente devido à persistência.
