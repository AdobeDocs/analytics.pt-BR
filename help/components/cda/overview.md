...
O uso do Cross-Device Analytics requer a [compilação em campo](field-based-stitching.md).
...
O Análise entre dispositivos é um recurso inovador e robusto, mas tem limitações na forma de uso. A [Compilação em campo](field-based-stitching.md) também tem limitações específicas.
